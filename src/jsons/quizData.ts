const quizzes=[{
  id: 1,
  subject: "Mathematics",
  question: "A farmer divides 36 mangoes equally into 4 baskets. How many mangoes are in each basket?",
  options: {
    A: "6",
    B: "9",
    C: "8",
  ...
  correctAnswer: "B",
  explanation:
    "Divide 36 by 4 to get 9 mangoes in each basket.",
},
{
  id: 2,
  subject: "English",
  question: "Choose the correct past tense form: 'She ___ the letter yesterday.'",
  options: {
    A: "writes",
    B: "written",
    C: "wrote",
...
},
{
  ...
  question: "Which of these is a source of energy used for cooking that comes from plants?",
  options: {
    A: "Coal",
    B: "Firewood",
    C: "Electricity",
...
},
{
  id: 7,
  subject: "Agriculture",
  question: "Which farming practice helps keep soil fertile by planting different crops each season?",
  options: {
    A: "Monoculture",
    B: "Crop rotation",
    C: "Deforestation",
...
},
{
  id: 8,
  subject: "Music",
  question: "Which musical symbol shows a pause in music that lasts for one beat in common time?",
  options: {
    A: "Whole note",
    B: "Quarter rest",
    C: "Half rest",
...
},
{
  ...
  question: "Which food group should make up the largest portion of a healthy plate?",
  options: {
    A: "Proteins",
    B: "Fats",
...
},
{
  ...
  question: "Which device is used to print text and pictures on paper from a computer?",
  options: {
    A: "Monitor",
    B: "Printer",
    C: "Keyboard",
...
},
{
  id: 13,
  subject: "English",
  question: "Pick the correct word: 'The sun is ___ than the moon in the sky.'",
  options: {
    A: "brighter",
    B: "brightest",
    C: "bright",
...
},
{
  id: 14,
  subject: "Kiswahili",
  question: "Tafsiri kwa Kiingereza: 'Ninapenda kusoma vitabu wakati wa wakati wa mapumziko.' Which is the correct translation?",
  options: {
...
},
{
  id: 18,
  subject: "Agriculture",
  question: "Which tool is commonly used to dig small holes for planting seedlings on a farm?",
  options: {
    A: "Sickle",
    B: "Hoe",
    C: "Sprayer",
...
},
{
  id: 19,
  subject: "Music",
  question: "If a song is in common time (4/4), how many beats are there in one bar?",
  options: {
    A: "3",
    B: "4",
    C: "2",
  ...
  correctAnswer: "B",
  explanation:
    "Common time (4/4) has four beats per bar.",
},
{
  id: 20,
  subject: "Home Science",
  question: "Which of the following is the best action to keep food safe from germs at home?",
  options: {
...
},
{
  id: 23,
  subject: "Mathematics",
  question: "If a bus carries 45 passengers and each row has 5 seats, how many rows are filled?",
  options: {
    A: "8",
    B: "9",
    C: "7",
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "Compute 3/4 × 28 = (3 × 28) ÷ 4 = 84 ÷ 4 = 21.",
},
{
  id: 27,
  subject: "English",
  question: "Choose the correct word to complete the sentence: 'The dog wagged ___ tail.'",
  options: {
    A: "its",
    B: "it's",
    C: "their",
...
},
{
  id: 30,
  subject: "Social Studies",
  question: "What is a citizen's duty when they are called to serve on a jury?",
  options: {
...
},
{
  id: 31,
  subject: "CRE",
  question: "Who is known for being tested by God with a series of sufferings but kept faith in the Bible?",
  options: {
    A: "Noah",
    B: "Job",
    C: "Solomon",
...
},
{
  id: 32,
  subject: "Agriculture",
  question: "Which practice helps conserve water on a farm by reducing evaporation from the soil?",
  options: {
    A: "Mulching",
    B: "Slash-and-burn",
    C: "Overwatering",
...
},
{
  id: 33,
  subject: "Music",
  question: "Which family of instruments includes the piano, violin, and guitar?",
  options: {
    A: "Brass",
    B: "Percussion",
    C: "String",
...
},
{
  id: 34,
  subject: "Home Science",
  question: "Which method is best for removing dirt from cotton clothing before washing?",
  options: {
...
},
{
  id: 35,
  subject: "Physical & Health Education",
  question: "Which nutrient is most important for building strong muscles after exercise?",
  options: {
    A: "Carbohydrates",
    B: "Proteins",
    C: "Sugars",
...
},
{
  id: 38,
  subject: "English",
  question: "Which word is an adjective in the sentence: 'The tall tree provided shade.'",
  options: {
    A: "tree",
    B: "provided",
    C: "shade",
...
},
{
  id: 39,
  subject: "Kiswahili",
  question: "Tafsiri: 'We must keep our environment clean.' Which is the best Kiswahili translation?",
  options: {
...
},
{
  id: 40,
  subject: "Science & Technology",
  question: "Which tool would you use to measure the temperature in a classroom?",
  options: {
    A: "Scale",
    B: "Thermometer",
    C: "Ruler",
...
},
{
  id: 41,
  subject: "Social Studies",
  question: "Which of the following is an example of a public service provided by government?",
  options: {
    A: "Private tutoring",
    B: "Road construction",
    C: "Small shop",
...
},
{
  id: 42,
  subject: "CRE",
  question: "Which book in the Bible contains the story of David and Goliath?",
  options: {
    A: "Exodus",
    B: "1 Samuel",
    C: "Genesis",
...
},
{
  id: 43,
  subject: "Agriculture",
  question: "What is the best time to plant crops that need a lot of water in a region with a rainy season?",
  options: {
...
},
{
  id: 45,
  subject: "Home Science",
  question: "Which cleaning agent is best for removing grease from kitchen utensils?",
  options: {
    A: "Baking powder",
    B: "Soap or detergent",
    C: "Plain water",
...
},
{
  id: 48,
  subject: "Mathematics",
  question: "A school bought 6 boxes of chalk. Each box has 12 pieces. How many pieces of chalk in total?",
  options: {
    A: "72",
    B: "18",
    C: "60",
  ...
  correctAnswer: "A",
  explanation:
    "Total pieces = 6 × 12 = 72 pieces of chalk.",
},
{
  id: 49,
  subject: "English",
...
},
{
  id: 50,
  subject: "Kiswahili",
  question: "Chagua kifungu kinachofaa: 'Tafadhali ___ meza kabla ya kuanza kula.'",
  options: {
    A: "osha",
    B: "oshea",
    C: "ponda",
...
},
{
  id: 51,
  subject: "Science & Technology",
  question: "Which part of the human body pumps blood to the rest of the body?",
  options: {
    A: "Liver",
    B: "Lungs",
    C: "Heart",
...
},
{
  id: 53,
  subject: "CRE",
  question: "In Christian teaching, what is the main message of the parable of the Good Samaritan?",
  options: {
...
},
{
  id: 54,
  subject: "Agriculture",
  question: "Which livestock is commonly kept for both milk and meat on small farms?",
  options: {
    A: "Cats",
    B: "Goats",
    C: "Sparrows",
...
},
{
  id: 58,
  subject: "ICT/Computer Studies",
  question: "Which application would you use to make a slide presentation for class?",
  options: {
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "The pattern increases by 3 each time; 21 + 3 = 24.",
},
{
  id: 60,
  subject: "English",
  question: "Choose the best question form for this statement: 'She can swim.'",
  options: {
    A: "Can she swim?",
    B: "She can swim?",
    C: "Do she swim?",
...
},
{
  id: 62,
  subject: "Science & Technology",
  question: "Which gas do plants use from the air to make food during photosynthesis?",
  options: {
    A: "Oxygen",
    B: "Carbon dioxide",
    C: "Nitrogen",
...
},
{
  id: 64,
  subject: "CRE",
  question: "Who received the Ten Commandments on Mount Sinai according to the Bible?",
  options: {
    A: "Moses",
    B: "Joseph",
    C: "Isaac",
...
},
{
  id: 65,
  subject: "Agriculture",
  question: "Which practice helps control pests without using chemical pesticides?",
  options: {
...
},
{
  id: 66,
  subject: "Music",
  question: "Which clef is commonly used for higher-pitched notes like the violin?",
  options: {
    A: "Bass clef",
    B: "Treble clef",
    C: "Alto clef",
...
},
{
  id: 67,
  subject: "Home Science",
  question: "Which vitamin is abundant in citrus fruits and helps prevent scurvy?",
  options: {
    A: "Vitamin C",
    B: "Vitamin D",
    C: "Vitamin K",
...
},
{
  id: 68,
  subject: "Physical & Health Education",
  question: "Which safety gear should you wear when riding a bicycle to prevent head injuries?",
    options: {
    A: "Helmet",
    B: "Sunglasses",
    C: "Flip-flops",
...
},
{
  id: 69,
  subject: "ICT/Computer Studies",
  question: "Which of these is used to connect to the internet over a phone line?",
  options: {
    A: "Modem",
    B: "Hard drive",
    C: "Graphics card",
...
},
{
  id: 73,
  subject: "Science & Technology",
  question: "Which simple machine is used to lift heavy loads by changing direction of force, often seen as a wheel with a rope?",
  options: {
    A: "Inclined plane",
    B: "Pulley",
    C: "Screw",
...
},
{
  id: 75,
  subject: "CRE",
  question: "Which prayer did Jesus teach his followers as a model in the New Testament?",
  options: {
    A: "The Shema",
    B: "The Lord's Prayer",
    C: "The Five Pillars",
  ...
  id: 76,
  subject: "Agriculture",
  question: "Which nutrient do legume crops add to the soil through their roots?",
  options: {
    A: "Phosphorus",
    B: "Nitrogen",
    C: "Potassium",
...
},
{
  id: 78,
  subject: "English",
  question: "Choose the correct plural form: 'There are many ___ in the sky.'",
  options: {
    A: "star",
    B: "stares",
    C: "stars",
...
},
{
  id: 82,
  subject: "CRE",
  question: "According to Christian belief, what does the resurrection of Jesus symbolize?",
  options: {
    A: "Defeat",
...
},
{
  id: 85,
  subject: "Physical & Health Education",
  question: "Which food group should athletes increase for energy during long activities?",
  options: {
    A: "Carbohydrates",
    B: "Vitamins",
    C: "Water only",
...
},
{
  id: 88,
  subject: "English",
  question: "Select the correct conjunction: 'I wanted to play, ___ it rained.'",
  options: {
    A: "but",
    B: "and",
    C: "so",
...
},
{
  id: 96,
  subject: "Physical & Health Education",
  question: "How long should children do moderate physical activity each day for good health (WHO guideline approximation)?",
  options: {
...
},
{
  id: 97,
  subject: "ICT/Computer Studies",
  question: "Which key combination is commonly used to copy selected text on a computer?",
  options: {
    A: "Ctrl + V",
    B: "Ctrl + C",
    C: "Ctrl + P",
...
},
{
  id: 101,
  subject: "Science & Technology",
  question: "Which part of a plant is mainly responsible for making food using sunlight?",
  options: {
    A: "Roots",
    B: "Stem",
    C: "Leaves",
...
},
{
  id: 103,
  subject: "CRE",
  question: "Which Old Testament figure built an ark to save his family and animals from a flood?",
  options: {
    A: "Noah",
    B: "David",
    C: "Samuel",
...
},
{
  id: 107,
  subject: "Physical & Health Education",
  question: "Which symptom suggests someone may be dehydrated during exercise?",
  options: {
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "First divide 45 by 9 = 5, then add 6 giving 11.",
},
{
  id: 110,
  subject: "English",
...
},
{
  id: 114,
  subject: "CRE",
  question: "Which fruit is used in the Bible to test Abraham's faith (metaphorically as offering)?",
  options: {
    A: "Olive",
    B: "Fig",
...
},
{
  id: 121,
  subject: "English",
  question: "Which word completes the comparison: 'This book is ___ than that one.'",
  options: {
    A: "more interesting",
    B: "most interesting",
    C: "interestinger",
...
},
{
  id: 124,
  subject: "Social Studies",
  question: "Which right allows citizens to choose their leaders in elections?",
  options: {
    A: "Right to vote",
    B: "Right to steal",
    C: "Right to pollute",
...
},
{
  ...
  id: 126,
  subject: "Agriculture",
  question: "Which practice helps increase soil fertility by adding organic matter?",
  options: {
...
},
{
  id: 128,
  subject: "English",
  question: "Choose the correct sentence with proper tense: 'By the time we arrived, the film ___.'",
  options: {
    A: "has started",
    B: "had started",
    C: "will start",
...
},
{
  id: 136,
  subject: "ICT/Computer Studies",
  question: "Which part of a computer is considered the 'brain' that processes instructions?",
  options: {
    A: "Monitor",
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "Cost per pen = 160 ÷ 4 = 40 shillings.",
},
{
  id: 138,
  subject: "English",
...
},
{
  id: 140,
  subject: "Science & Technology",
  question: "Which renewable energy source uses flowing water to produce electricity?",
  options: {
    A: "Coal",
    B: "Hydropower",
    C: "Oil",
...
},
{
  id: 142,
  subject: "CRE",
  question: "Which fruit is often used as a symbol of peace in Christian art (and elsewhere)?",
  options: {
    A: "Apple",
...
},
{
  id: 143,
  subject: "Agriculture",
  question: "Which crop is commonly intercropped with maize to improve use of space on small farms?",
  options: {
    A: "Rice",
    B: "Beans",
    C: "Wheat",
...
},
{
  ...
  id: 151,
  subject: "Science & Technology",
  question: "Which observed change indicates a chemical reaction has occurred?",
  options: {
    A: "Change of shape",
...
},
{
  id: 153,
  subject: "English",
  question: "Choose the correct homophone: 'They went to ___ house to visit.'",
  options: {
    A: "there",
    B: "their",
    C: "they're",
...
},
{
  id: 155,
  subject: "Social Studies",
  question: "Which organization helps countries work together on health issues worldwide?",
  options: {
...
},
{
  id: 156,
  subject: "CRE",
  question: "Which act is an example of showing love to your neighbour in Christian teaching?",
  options: {
...
},
{
  id: 157,
  subject: "Agriculture",
  question: "Which tool is best for cutting grass in a small homestead garden?",
  options: {
    A: "Sickle",
    B: "Combine harvester",
    C: "Ploughing tractor",
...
},
{
  id: 160,
  subject: "Physical & Health Education",
  question: "Which activity helps improve balance and coordination in children?",
  options: {
...
},
{
  ...
  correctAnswer: "C",
  explanation:
    "Multiplying 7 by 8 gives 56, a basic multiplication fact.",
},
{
  id: 163,
  subject: "English",
...
},
{
  id: 165,
  subject: "Science & Technology",
  question: "Which metal is commonly used to make cooking pots because it conducts heat well?",
  options: {
    A: "Aluminium",
    B: "Wood",
    C: "Glass",
...
},
{
  id: 167,
  subject: "CRE",
  question: "Which act is an example of forgiveness taught in Christian faith?",
  options: {
    A: "Holding a grudge",
...
},
{
  id: 168,
  subject: "Agriculture",
  question: "Which method helps farmers protect crops from wild animals at night?",
  options: {
...
},
{
  id: 170,
  subject: "Home Science",
  question: "Which is a balanced meal component that should be included for growth?",
  options: {
...
},
{
  id: 172,
  subject: "ICT/Computer Studies",
  question: "Which device would you use to listen to audio from a computer privately?",
  options: {
    A: "Printer",
    B: "Headphones",
    C: "Router",
...
},
{
  id: 174,
  subject: "English",
  question: "Which word is a verb in the sentence: 'Children play games after school.'",
  options: {
    A: "Children",
    B: "play",
    C: "games",
...
},
{
  id: 176,
  subject: "Science & Technology",
  question: "Which material is transparent and lets light pass through clearly?",
  options: {
    A: "Glass",
    B: "Wood",
    C: "Brick",
...
},
{
  id: 178,
  subject: "CRE",
  question: "Which action by Joseph in the Bible showed forgiveness to his brothers?",
  options: {
...
},
{
  id: 179,
  subject: "Agriculture",
  question: "Which factor is most important when selecting crop seeds for planting?",
  options: {
...
},
{
  id: 181,
  subject: "Home Science",
  question: "Which kitchen habit reduces the spread of bacteria while preparing food?",
  options: {
...
},
{
  id: 183,
  subject: "ICT/Computer Studies",
  question: "Which action saves a file under a new name, keeping the original unchanged?",
  options: {
    A: "Open",
    B: "Save As",
    C: "Delete",
...
},
{
  id: 184,
  subject: "Mathematics",
  question: "If a classroom has 24 pupils and they sit in rows of 6, how many rows are there?",
  options: {
    A: "2",
    B: "3",
    C: "4",
...
},
{
  id: 187,
  subject: "Science & Technology",
  question: "Which device converts electrical energy into light and heat in many homes?",
  options: {
    A: "Battery",
    B: "Light bulb",
    C: "Switch",
...
},
{
  id: 189,
  subject: "CRE",
  question: "Which Psalm is often associated with trust in God (common example used in schools)?",
  options: {
    A: "Psalm 23",
    B: "Psalm 150",
    C: "Psalm 1",
...
},
{
  id: 192,
  subject: "Home Science",
  question: "Which food should be stored separately to avoid contaminating other foods?",
  options: {
    A: "Fresh fruit",
    B: "Raw meat",
    C: "Dry cereal",
...
},
{
  id: 193,
  subject: "Physical & Health Education",
  question: "Which practice helps prevent heat exhaustion during hot weather?",
  options: {
...
},
{
  id: 198,
  subject: "Science & Technology",
  question: "Which organ helps in breathing by exchanging gases in the human body?",
  options: {
    A: "Heart",
    B: "Lungs",
    C: "Stomach",
...
},
{
  id: 199,
  subject: "Social Studies",
  question: "Which is a responsibility of children at home to help the family?",
  options: {
...
},
{
  id: 200,
  subject: "CRE",
  question: "Which fruit did Jesus use in a teaching about faith (metaphorically compared to small faith)?",
  options: {
  ...
  id: 201,
  subject: "Agriculture",
  question: "Which practice helps improve soil structure by adding earthworms and organic matter?",
  options: {
    A: "Overwatering",
    B: "Adding compost",
...
},
{
  id: 206,
  subject: "Social Studies",
  question: "Which institution is responsible for teaching children in a community?",
  options: {
    A: "School",
    B: "Factory",
    C: "Bus stop",
...
},
{
  id: 216,
  subject: "Social Studies",
  question: "Which term describes people who move into a country from another country?",
  options: {
    A: "Emigrants",
    B: "Immigrants",
    C: "Tourists",
...
},
{
  id: 222,
  subject: "ICT/Computer Studies",
  question: "Which symbol is commonly used to send an email message in an email client?",
  options: {
    A: "Paper clip",
    B: "Trash can",
...
},
{
  id: 226,
  subject: "Science & Technology",
  question: "Which simple machine is a ramp that helps lift objects more easily?",
  options: {
    A: "Wedge",
    B: "Inclined plane",
    C: "Pulley",
...
},
{
  id: 228,
  subject: "CRE",
  question: "Which figure in the Bible is famous for great wisdom and building a temple?",
  options: {
    A: "Solomon",
    B: "Cain",
    C: "Jonah",
...
},
{
  id: 229,
  subject: "Agriculture",
  question: "Which method helps farmers keep pests away using living organisms?",
  options: {
...
},
{
  id: 230,
  subject: "Music",
  question: "Which word describes the pattern of long and short sounds in music?",
  options: {
    A: "Pitch",
    B: "Dynamics",
    C: "Rhythm",
...
},
{
  id: 231,
  subject: "Home Science",
  question: "Which container is best for storing leftover soup in the refrigerator?",
  options: {
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "Multiply 9 × 7 to get 63.",
},
{
  id: 235,
  subject: "English",
  question: "Which word completes the sentence: 'She is the ___ student in class.'",
  options: {
    A: "taller",
    B: "tallest",
    C: "tall",
...
},
{
  id: 237,
  subject: "Science & Technology",
  question: "Which simple tool helps compare temperatures between two places?",
  options: {
    A: "Thermometer",
    B: "Ruler",
    C: "Compass",
...
},
{
  id: 238,
  subject: "Social Studies",
  question: "Which festival is often celebrated to remember a nation's independence?",
  options: {
    A: "Independence Day",
    B: "Weekly market day",
    C: "Sports day only",
...
},
{
  id: 239,
  subject: "CRE",
  question: "Which prophet in the Old Testament was swallowed by a big fish according to the Bible story?",
  options: {
    A: "Jonah",
    B: "Elijah",
    C: "Daniel",
...
},
{
  id: 243,
  subject: "Physical & Health Education",
  question: "Which heart rate change shows that exercise intensity is increasing?",
  options: {
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "3 divided by 10 equals 0.3, so 3/10 is 0.3 in decimal form.",
},
{
  id: 246,
  subject: "English",
...
},
{
  id: 249,
  subject: "Social Studies",
  question: "Which is a reason people form groups like clubs or associations?",
  options: {
...
},
{
  id: 251,
  subject: "Agriculture",
  question: "Which farming activity should be done soon after planting to reduce weed competition?",
  options: {
    A: "Weeding early",
...
},
{
  id: 255,
  subject: "ICT/Computer Studies",
  question: "Which is a commonly used operating system for personal computers?",
  options: {
    A: "Windows",
    B: "HTML",
    C: "JPEG",
...
},
{
  id: 257,
  subject: "English",
  question: "Choose the correct comparative: 'This puzzle is ___ than the other one.'",
  options: {
    A: "easyest",
    B: "easier",
    C: "most easy",
...
},
{
  id: 261,
  subject: "CRE",
  question: "Which miracle showed Jesus' power over nature by calming a storm?",
  options: {
    A: "Healing the blind",
...
},
{
  id: 262,
  subject: "Agriculture",
  question: "Which is an advantage of planting cover crops during off-season?",
  options: {
...
},
{
  id: 264,
  subject: "Home Science",
  question: "Which practice prevents cross-contamination when preparing food?",
  options: {
...
},
{
  id: 266,
  subject: "ICT/Computer Studies",
  question: "Which of the following stores information permanently even when the computer is off?",
  options: {
    A: "RAM",
...
},
{
  id: 270,
  subject: "Science & Technology",
  question: "Which device protects an electrical circuit by breaking the flow when current is too high?",
  options: {
    A: "Resistor",
...
},
{
  id: 272,
  subject: "CRE",
  question: "Which event marks the birth of Jesus according to Christian belief?",
  options: {
    A: "Easter",
    B: "Christmas",
    C: "Pentecost",
...
},
{
  id: 273,
  subject: "Agriculture",
  question: "Which planting method reduces soil disturbance and helps retain moisture?",
  options: {
    A: "No-till farming",
...
},
{
  id: 274,
  subject: "Music",
  question: "Which clef is commonly used for low-pitched instruments like the cello?",
  options: {
    A: "Treble clef",
    B: "Bass clef",
    C: "Alto clef",
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "Convert to common denominator 6: (4/6) + (1/6) = 5/6.",
},
{
  id: 279,
  subject: "English",
...
},
{
  id: 281,
  subject: "Science & Technology",
  question: "Which material is commonly used to make a simple magnet stronger when wrapped around iron?",
  options: {
...
},
{
  id: 283,
  subject: "CRE",
  question: "Which gift is associated with the Holy Spirit at Pentecost in Christian teaching?",
  options: {
    A: "Fasting only",
...
},
{
  id: 284,
  subject: "Agriculture",
  question: "Which livestock product provides protein and calcium in many diets?",
  options: {
    A: "Leather",
    B: "Milk",
    C: "Wool",
...
},
{
  id: 288,
  subject: "ICT/Computer Studies",
  question: "Which device connects multiple computers to share an internet connection in a home?",
  options: {
    A: "Router",
    B: "Scanner",
    C: "Monitor",
...
},
{
  id: 294,
  subject: "CRE",
  question: "Which person in the Bible was known for leading the Israelites into the Promised Land after Moses?",
  options: {
    A: "Joshua",
    B: "David",
    C: "Saul",
...
},
{
  id: 295,
  subject: "Agriculture",
  question: "Which practice helps protect seedlings from strong sunlight when transplanted?",
  options: {
...
},
{
  id: 298,
  subject: "Physical & Health Education",
  question: "Which is a healthy daily habit for children to support immunity?",
  options: {
...
},
{
  id: 300,
  subject: "Mathematics",
  question: "If you count by twos starting at 2, which number is the tenth in the list?",
  options: {
    A: "18",
    B: "20",
    C: "22",
...
},
{
  id: 305,
  subject: "Social Studies",
  question: "Who represents the people of a ward in local government in many systems?",
  options: {
...
},
{
  id: 306,
  subject: "CRE",
  question: "Which Old Testament leader was known for receiving God's law and leading the Israelites out of Egypt?",
  options: {
    A: "Moses",
    B: "Noah",
    C: "Abel",
...
},
{
  id: 307,
  subject: "Agriculture",
  question: "Which practice reduces soil nutrient loss by planting a crop after harvest?",
  options: {
    A: "Leaving soil bare",
...
},
{
  id: 309,
  subject: "Home Science",
  question: "Which is a good way to remove stains from clothes before washing?",
  options: {
...
},
{
  id: 311,
  subject: "ICT/Computer Studies",
  question: "Which key is used to start a new paragraph in many text editors?",
  options: {
    A: "Enter (Return)",
    B: "Ctrl",
    C: "Alt",
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "Half of 64 is 64 ÷ 2 = 32.",
},
{
  id: 313,
  subject: "English",
  question: "Which word is a conjunction in the sentence: 'She danced and sang at the party.'",
  options: {
    A: "She",
    B: "danced",
    C: "and",
...
},
{
  id: 315,
  subject: "Science & Technology",
  question: "Which food takes the longest to decompose naturally: paper, plastic, banana peel, or leaves?",
  options: {
    A: "Banana peel",
    B: "Leaves",
    C: "Paper",
...
},
{
  id: 316,
  subject: "Social Studies",
  question: "Which is a democratic way to resolve disagreements in a community?",
  options: {
...
},
{
  id: 317,
  subject: "CRE",
  question: "Which Christian teaching emphasizes loving God and loving your neighbour?",
  options: {
...
},
{
  id: 318,
  subject: "Agriculture",
  question: "Which storage method helps keep harvested grain dry and safe from pests?",
  options: {
...
},
{
  id: 320,
  subject: "Home Science",
  question: "Which oil is healthier for cooking at medium heat compared to deep frying oils?",
  options: {
...
},
{
  id: 327,
  subject: "Social Studies",
  question: "Which public place is commonly used for voting during elections?",
  options: {
...
},
{
  id: 328,
  subject: "CRE",
  question: "Which gift did the Holy Spirit give the early disciples at Pentecost that helped them speak about Jesus to many people?",
  options: {
...
},
{
  id: 330,
  subject: "Music",
  question: "Which term indicates a single sustained pitch held for a long time?",
  options: {
    A: "Staccato",
...
},
{
  id: 331,
  subject: "Home Science",
  question: "Which is a safe practice when storing cooked food in the refrigerator?",
  options: {
...
},
{
  id: 332,
  subject: "Physical & Health Education",
  question: "Which nutrient is important for quick energy before sports activities?",
  options: {
    A: "Carbohydrates",
    B: "Iron only",
    C: "Calcium only",
...
},
{
  id: 333,
  subject: "ICT/Computer Studies",
  question: "Which file type is commonly used for documents created in word processors?",
  options: {
    A: ".mp3",
    B: ".docx",
    C: ".jpg",
...
},
{
  id: 337,
  subject: "Science & Technology",
  question: "Which object is needed to see distant stars and planets more clearly from Earth?",
  options: {
    A: "Telescope",
    B: "Microscope",
    C: "Thermometer",
...
},
{
  id: 338,
  subject: "Social Studies",
  question: "Which right is important for children in schools to be treated fairly?",
  options: {
...
},
{
  id: 339,
  subject: "CRE",
  question: "Which action shows hospitality as encouraged in Christian teachings?",
  options: {
...
},
{
  id: 340,
  subject: "Agriculture",
  question: "Which nutrient is commonly deficient in soils and often added as fertilizer to improve plant growth?",
  options: {
    A: "Nitrogen",
    B: "Gold",
    C: "Helium",
...
},
{
  id: 343,
  subject: "Physical & Health Education",
  question: "Which habit helps reduce risk of contagious diseases during outbreaks?",
  options: {
...
},
{
  id: 344,
  subject: "ICT/Computer Studies",
  question: "Which device converts digital documents into editable text using OCR (optical character recognition)?",
  options: {
...
},
{
  id: 348,
  subject: "Science & Technology",
  question: "Which device is used to measure mass of an object in a science lab?",
  options: {
    A: "Thermometer",
    B: "Balance or scale",
    C: "Clock",
...
},
{
  id: 349,
  subject: "Social Studies",
  question: "Which is a cultural practice often passed down through families?",
  options: {
...
},
{
  id: 350,
  subject: "CRE",
  question: "Which prophet was famous for interpreting dreams in the Old Testament and became a leader in Egypt?",
  options: {
    A: "Joseph",
    B: "Elijah",
    C: "Isaiah",
...
},
{
  id: 353,
  subject: "Home Science",
  question: "Which household item can remove mild stains from fabric without harsh chemicals?",
  options: {
    A: "Baking soda paste",
    B: "Motor oil",
    C: "Paint thinner",
...
},
{
  id: 354,
  subject: "Physical & Health Education",
  question: "Which sign suggests someone may need medical help after a head injury?",
  options: {
...
},
{
  id: 355,
  subject: "ICT/Computer Studies",
  question: "Which program is best for creating and calculating with tables of numbers?",
  options: {
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "Subtract 37 from 100: 100 − 37 = 63.",
},
{
  id: 357,
  subject: "English",
...
},
{
  id: 359,
  subject: "Science & Technology",
  question: "Which human body system carries oxygen to cells and removes carbon dioxide?",
  options: {
    A: "Digestive system",
...
},
{
  id: 362,
  subject: "Agriculture",
  question: "Which seed storage practice helps maintain seed viability until planting season?",
  options: {
...
},
{
  id: 364,
  subject: "Home Science",
  question: "Which breakfast choice provides a good balance of energy and nutrients?",
  options: {
...
},
{
  id: 371,
  subject: "Social Studies",
  question: "Which institution keeps records of births and deaths in a country?",
  options: {
...
},
{
  id: 372,
  subject: "CRE",
  question: "Which Bible story shows the importance of sharing food with the hungry?",
  options: {
...
},
{
  id: 373,
  subject: "Agriculture",
  question: "Which practice helps increase crop yield by providing the right amounts of water?",
  options: {
...
},
{
  id: 374,
  subject: "Music",
  question: "Which word describes notes played with separation and shortness?",
  options: {
    A: "Legato",
    B: "Staccato",
    C: "Crescendo",
...
},
{
  id: 381,
  subject: "Science & Technology",
  question: "Which tool helps mix ingredients evenly in a science practical or cooking?",
  options: {
    A: "Stirrer or spoon",
    B: "Hammer",
    C: "Screwdriver",
...
},
{
  id: 383,
  subject: "CRE",
  question: "Which parable teaches forgiveness by comparing a servant forgiven a large debt who then fails to forgive a small debt?",
  options: {
...
},
{
  id: 386,
  subject: "Home Science",
  question: "Which step helps keep kitchen surfaces sanitary after preparing raw meat?",
  options: {
...
},
{
  id: 392,
  subject: "Science & Technology",
  question: "Which simple change is physical, not chemical: melting ice or burning paper?",
  options: {
...
},
{
  id: 400,
  subject: "Mathematics",
  question: "If a pizza is cut into 8 equal slices and you eat 3, what fraction of the pizza remains?",
  options: {
    A: "3/8",
    B: "5/8",
    C: "1/2",
...
},
{
  id: 402,
  subject: "English",
  question: "Which word correctly completes: 'Please put the books ___ the shelf.'",
  options: {
    A: "on",
    B: "in",
    C: "underneathly",
...
},
{
  id: 404,
  subject: "Science & Technology",
  question: "Which device uses magnets and coils to produce electricity from moving water in a hydro plant?",
  options: {
    A: "Motor",
    B: "Generator",
    C: "Light bulb",
...
},
{
  id: 405,
  subject: "Social Studies",
  question: "Which national institution is commonly responsible for collecting taxes?",
  options: {
...
},
{
  id: 407,
  subject: "Agriculture",
  question: "Which farm practice improves soil by planting legume cover crops and then mixing them into the soil?",
  options: {
    A: "Green manuring",
    B: "Burning residues",
...
},
{
  id: 408,
  subject: "Music",
  question: "Which term refers to singing without instrumental accompaniment?",
  options: {
    A: "Accompanied",
    B: "Unison",
    C: "A cappella",
...
},
{
  id: 409,
  subject: "Home Science",
  question: "Which spice can help add flavor to food and also has preservative qualities?",
  options: {
    A: "Salt",
    B: "Plastic",
    C: "Sand",
...
},
{
  id: 411,
  subject: "ICT/Computer Studies",
  question: "Which shortcut often pastes copied content into a document on many computers?",
  options: {
    A: "Ctrl + C",
    B: "Ctrl + V",
    C: "Ctrl + X",
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "One quarter equals 1 ÷ 4 = 0.25 in decimal form.",
},
{
  id: 413,
  subject: "English",
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "'Tulilala mapema' is past tense and means 'We slept early.'",
},
{
  id: 415,
  subject: "Science & Technology",
  question: "Which simple machine is a lever used for lifting a heavy stone with less effort?",
  options: {
    A: "Inclined plane",
    B: "Lever",
    C: "Pulley",
...
},
{
  id: 417,
  subject: "CRE",
  question: "Which Old Testament figure is associated with great strength and the story of the Philistines?",
  options: {
    A: "Samson",
    B: "Solomon",
    C: "Moses",
...
},
{
  id: 418,
  subject: "Agriculture",
  question: "Which weather condition is best for harvesting dry cereals like maize to avoid rot?",
  options: {
    A: "Wet and rainy",
    B: "Dry and sunny",
    C: "Foggy and humid",
...
},
{
  id: 420,
  subject: "Home Science",
  question: "Which utensil material is safer for cooking acidic foods without reacting?",
  options: {
    A: "Aluminum uncoated",
    B: "Stainless steel",
    C: "Copper untreated",
...
},
{
  id: 422,
  subject: "ICT/Computer Studies",
  question: "Which item is a removable storage medium for transferring small files?",
  options: {
    A: "USB flash drive",
    B: "Monitor cable",
    C: "Power cord",
...
},
{
  id: 423,
  subject: "Mathematics",
  question: "If a library has 5 shelves and each shelf holds 24 books, how many books in total?",
  options: {
    A: "100",
    B: "120",
    C: "130",
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "The future tense uses 'will' + base verb: 'I will visit'.",
},
{
  id: 425,
  subject: "Kiswahili",
...
},
{
  id: 428,
  subject: "CRE",
  question: "Which act did Jesus say was the greatest commandment alongside loving God?",
  options: {
    A: "Hoarding wealth",
...
},
{
  id: 429,
  subject: "Agriculture",
  question: "Which agricultural product is obtained by tapping the sap of certain trees?",
  options: {
    A: "Honey",
    B: "Latex (rubber)",
    C: "Wool",
...
},
{
  id: 430,
  subject: "Music",
  question: "Which term describes singing or playing in one voice or line together?",
  options: {
    A: "Polyphony",
    B: "Unison",
    C: "Harmony",
...
},
{
  id: 432,
  subject: "Physical & Health Education",
  question: "Which component of fitness is improved by jumping and hopping activities?",
  options: {
    A: "Flexibility only",
...
},
{
  id: 433,
  subject: "ICT/Computer Studies",
  question: "Which protocol is used to view web pages on the internet (seen at start of web addresses)?",
  options: {
    A: "HTTP or HTTPS",
    B: "FTP only",
    C: "SMTP",
...
},
{
  id: 434,
  subject: "Mathematics",
  question: "Which is the sum of the interior angles of a triangle in degrees?",
  options: {
    A: "180°",
    B: "360°",
    C: "90°",
...
},
{
  id: 435,
  subject: "English",
  question: "Which word is an adjective describing colour in 'The bright kite flew high.'?",
  options: {
    A: "The",
    B: "bright",
    C: "kite",
...
},
{
  id: 439,
  subject: "CRE",
  question: "Which action is an example of mercy taught in religious teachings?",
  options: {
...
},
{
  id: 440,
  subject: "Agriculture",
  question: "Which practice reduces the spread of plant diseases between crops?",
  options: {
...
},
{
  id: 441,
  subject: "Music",
  question: "Which scale has seven different notes before repeating the octave?",
  options: {
    A: "Chromatic scale",
    B: "Pentatonic scale",
...
},
{
  id: 442,
  subject: "Home Science",
  question: "Which household item can be used to check that food is cooked thoroughly (meat)?",
  options: {
    A: "Food thermometer",
    B: "Ruler",
    C: "Pencil",
...
},
{
  id: 444,
  subject: "ICT/Computer Studies",
  question: "Which tool helps check spelling as you type in many text editors?",
  options: {
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "17 ÷ 5 = 3 remainder 2, so the remainder is 2.",
},
{
  id: 446,
  subject: "English",
...
},
{
  id: 448,
  subject: "Science & Technology",
  question: "Which layer of the Earth is liquid and lies under the crust and mantle? (basic simplified view)",
  options: {
    A: "Inner core",
    B: "Outer core",
    C: "Crust",
...
},
{
  id: 450,
  subject: "CRE",
  question: "Which king asked for wisdom and became famous for wise judgments in the Bible?",
  options: {
    A: "Solomon",
    B: "Herod",
    C: "Nabal",
...
},
{
  id: 451,
  subject: "Agriculture",
  question: "Which practice helps control soil erosion by planting rows across the slope?",
  options: {
    A: "Contour farming",
...
},
{
  id: 452,
  subject: "Music",
  question: "Which clef places middle C on the first ledger line below the staff?",
  options: {
    A: "Treble clef",
    B: "Bass clef",
    C: "Alto clef",
...
},
{
  id: 456,
  subject: "Mathematics",
  question: "Which is the same as 6 × (2 + 3) using the distributive property?",
  options: {
    A: "6 × 2 + 6 × 3",
    B: "6 × 2 − 6 × 3",
    C: "6 + 2 × 3",
  ...
  correctAnswer: "A",
  explanation:
    "Distributive property: 6 × (2 + 3) = 6×2 + 6×3.",
},
{
  id: 457,
  subject: "English",
...
},
{
  id: 459,
  subject: "Science & Technology",
  question: "Which part of a microscope magnifies the specimen first when viewing?",
  options: {
    A: "Objective lens",
    B: "Stage",
    C: "Base",
...
},
{
  id: 460,
  subject: "Social Studies",
  question: "Which role do community elders often play in traditional societies?",
  options: {
...
},
{
  id: 461,
  subject: "CRE",
  question: "Which miracle story involves a prophet being taken up to heaven in a whirlwind accompanied by a chariot of fire?",
  options: {
    A: "Elijah",
    B: "Moses",
    C: "Jonah",
...
},
{
  id: 462,
  subject: "Agriculture",
  question: "Which farm animal is commonly used to plough fields in small-scale farming in many areas?",
  options: {
    A: "Cow or oxen",
    B: "Cat",
    C: "Chicken",
...
},
{
  id: 463,
  subject: "Music",
  question: "Which term describes a short, accented note followed by a longer one in rhythm patterns?",
  options: {
    A: "Syncopation",
    B: "Legato",
    C: "Monophony",
...
},
{
  id: 464,
  subject: "Home Science",
  question: "Which storage place is best for dry goods like flour to keep them fresh?",
  options: {
...
},
{
  id: 466,
  subject: "ICT/Computer Studies",
  question: "Which device converts typed characters into digital signals the computer can read?",
  options: {
    A: "Keyboard",
    B: "Monitor",
    C: "Speaker",
...
},
{
  id: 471,
  subject: "Social Studies",
  question: "Which public holiday commonly celebrates workers and labour rights in many countries?",
  options: {
...
},
{
  id: 472,
  subject: "CRE",
  question: "Which action did Joseph (in the New Testament) show towards his brothers when he revealed himself in Egypt? (different from earlier Joseph question)",
  options: {
...
},
{
  id: 473,
  subject: "Agriculture",
  question: "Which crop is harvested for its edible underground stem called a tuber?",
  options: {
    A: "Potato",
    B: "Wheat",
    C: "Apple",
...
},
{
  id: 474,
  subject: "Music",
  question: "Which musical texture features a single melodic line without harmony?",
  options: {
    A: "Polyphony",
    B: "Monophony",
    C: "Homophony",
...
},
{
  id: 475,
  subject: "Home Science",
  question: "Which practice reduces the chance of burns when boiling liquids?",
  options: {
...
},
{
  id: 482,
  subject: "Social Studies",
  question: "Which is a benefit of saving money in a community savings group?",
  options: {
...
},
{
  id: 483,
  subject: "CRE",
  question: "Which New Testament book records the early Christian church and Pentecost events?",
  options: {
...
},
{
  id: 484,
  subject: "Agriculture",
  question: "Which practice helps reduce the need for chemical pesticides by encouraging beneficial insects?",
  options: {
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "Pianissimo (pp) instructs performers to play very softly.",
},
{
  id: 486,
  subject: "Home Science",
...
},
{
  id: 494,
  subject: "CRE",
  question: "Which action did the Good Samaritan take for the injured man in the parable?",
  options: {
...
},
{
  id: 503,
  subject: "Science & Technology",
  question: "Which process turns ice directly into water vapour without becoming liquid?",
  options: {
    A: "Melting",
    B: "Evaporation",
    C: "Sublimation",
...
},
{
  id:  504,
  subject: "Social Studies",
  question: "Which document outlines a country's basic laws and principles of government?",
  options: {
    A: "Constitution",
    B: "Recipe book",
    C: "History book",
...
},
{
  id: 505,
  subject: "CRE",
  question: "Which Christian festival celebrates Jesus' entry into Jerusalem on a donkey?",
  options: {
    A: "Palm Sunday",
    B: "Good Friday",
    C: "Maundy Thursday",
...
},
{
  id: 509,
  subject:  "Home Science",
  question:  "Which practice helps prevent food poisoning when preparing salads?",
  options: {
...
},
{
  id: 510,
  subject:  "Physical & Health Education",
  question: "Which exercise strengthens core muscles in the abdomen and back?",
  options: {
    A: "Planks",
    B: "Only sleeping",
    C: "Watching TV",
...
},
{
  id: 511,
  subject:  "ICT/Computer Studies",
  question: "Which action deletes selected text without copying it to the clipboard?",
  options:  {
...
},
{
  id: 517,
  subject: "CRE",
  question: "Which beatitude teaches about those who hunger and thirst for righteousness?",
  options: {
...
},
{
  id: 519,
  subject: "Music",
  question: "Which instrument produces the deepest sounds in a standard orchestra?",
  options: {
    A: "Flute",
    B: "Violin",
    C: "Double bass",
...
},
{
  id: 522,
  subject:  "ICT/Computer Studies",
  question: "Which folder typically stores downloaded files by default on many computers?",
  options: {
    A: "Downloads folder",
    B: "Recycling bin",
    C: "Desktop only",
...
},
{
  ...
  correctAnswer: "C",
  explanation:
    "'Occasion' is the correct spelling with two C's and two S's.",
},
{
  id: 525,
  subject: "Kiswahili",
...
},
{
  id: 526,
  subject: "Science & Technology",
  question: "Which process allows plants to produce oxygen and food from sunlight?",
  options:  {
    A: "Respiration",
    B: "Photosynthesis",
    C: "Fermentation",
...
},
{
  id:  534,
  subject: "Mathematics",
  question: "Which shape has all sides equal and all angles equal at 60 degrees?",
  options:  {
    A: "Square",
...
},
{
  id:  536,
  subject: "Kiswahili",
  question: "Chagua tafsiri:  'I will go to the market tomorrow to buy vegetables.'",
  options: {
...
},
{
  id: 539,
  subject: "CRE",
  question: "Which parable teaches the value of helping others without expecting reward?",
  options: {
...
},
{
  id: 544,
  subject: "ICT/Computer Studies",
  question: "Which button on a browser goes back to the previously visited page?",
  options:  {
    A: "Forward button",
    B: "Back button",
    C: "Refresh button",
...
},
{
  id: 550,
  subject: "CRE",
  question: "Which fruit tree in the Bible is associated with peace and olive oil?",
  options: {
    A: "Fig tree",
    B: "Olive tree",
    C: "Apple tree",
...
},
{
  id: 551,
  subject:  "Agriculture",
  question: "Which livestock benefit from having access to clean drinking water daily?",
  options: {
...
},
{
  id: 552,
  subject: "Music",
  question:  "Which instrument family has instruments that vibrate to produce sound without being struck?",
  options: {
...
},
{
  id: 553,
  subject: "Home Science",
  question: "Which spice helps prevent bacterial growth in food and adds flavour?",
  options: {
    A: "Garlic and ginger",
    B: "Sugar",
    C: "Water",
...
},
{
  id: 555,
  subject: "ICT/Computer Studies",
  question: "Which feature allows multiple users to work on the same document online?",
  options: {
...
},
{
  id: 557,
  subject: "English",
  question: "Which word is an adverb in:  'She walked slowly through the garden.'?",
  options: {
    A: "walked",
    B: "slowly",
    C: "garden",
...
},
{
  id: 558,
  subject: "Kiswahili",
  question: "Chagua tafsiri ya 'The students are studying hard for their exam.'",
  options: {
...
},
{
  id: 561,
  subject: "CRE",
  question: "Which verse is known as the 'Golden Rule' in Christian teaching?",
  options: {
...
},
{
  id: 562,
  subject: "Agriculture",
  question: "Which practice helps prevent pest population explosions on farms?",
  options: {
...
},
{
  id:  564,
  subject: "Home Science",
  question: "Which is the correct way to dispose of cooking oil from frying? ",
  options: {
...
},
{
  id:  569,
  subject: "Kiswahili",
  question: "Chagua sahihi:  'Mfalme aliamua ___ watu wote kwamba wasilize nyinyi.'",
  options: {
    A: "kusema",
    B: "kusemeza",
    C: "kusemeza",
...
},
{
  id: 570,
  subject:  "Science & Technology",
  question: "Which simple machine reduces effort needed to lift loads using a curved path?",
  options: {
    A: "Lever",
    B: "Inclined plane",
    C: "Pulley",
...
},
{
  id: 572,
  subject:  "CRE",
  question: "Which Psalm is often recited for comfort and assurance in times of difficulty?",
  options: {
    A: "Psalm 23",
    B: "Psalm 150",
    C: "Psalm 1",
...
},
{
  id:  573,
  subject: "Agriculture",
  question: "Which method helps keep stored grains safe from insects without chemicals?",
  options: {
...
},
{
  id: 574,
  subject: "Music",
  question: "Which instrument is a member of the woodwind family despite having metal keys?",
  options: {
    A: "Saxophone",
    B: "Clarinet",
    C: "Flute",
...
},
{
  id: 583,
  subject: "CRE",
  question: "Which Christian denomination emphasizes personal conversion and Bible reading?",
  options: {
    A: "Protestant",
    B: "Sikh",
    C: "Muslim",
...
},
{
  id: 584,
  subject: "Agriculture",
  question: "Which factor determines the best time to harvest fruits for maximum sweetness?",
  options: {
...
},
{
  id: 585,
  subject: "Music",
  question:  "Which instrument is the smallest and plays the highest notes in a string orchestra?",
  options: {
    A: "Cello",
    B: "Violin",
    C: "Viola",
...
},
{
  id:  592,
  subject: "Science & Technology",
  question:  "Which process involves the separation of a mixture using boiling and condensation?",
  options: {
    A: "Filtration",
    B: "Distillation",
    C:  "Evaporation",
...
},
{
  id: 594,
  subject:  "CRE",
  question: "Which action is considered breaking the Sabbath in Jewish tradition?",
  options:  {
...
},
{
  id: 595,
  subject:  "Agriculture",
  question: "Which crop is sensitive to frost and must be planted after the last frost date?",
  options: {
    A: "Tomatoes",
    B: "Wheat",
    C: "Barley",
...
},
{
  id: 596,
  subject:  "Music",
  question: "Which musical form has multiple short pieces or movements played together?",
  options: {
    A: "Suite",
    B: "Fugue",
    C: "Sonata",
...
},
{
  id:  597,
  subject: "Home Science",
  question: "Which is a balanced way to divide household chores among family members?",
  options:  {
...
},
{
  ...
  id: 601,
  subject:  "English",
  question: "Which word best completes:  'The weather is ___ today than yesterday.'?",
  options: {
    A: "warmer",
    B: "warmest",
    C: "warm",
...
},
{
  id: 606,
  subject: "CRE",
  question: "Which action did Jesus demonstrate when he washed the disciples' feet?",
  options: {
    A:  "Pride",
...
},
{
  id: 607,
  subject:  "Agriculture",
  question: "Which practice helps reduce the cost of farming by reusing agricultural waste?",
  options: {
...
},
{
  id: 611,
  subject: "ICT/Computer Studies",
  question: "Which symbol separates the username from the domain in an email address?",
  options:  {
    A: "Underscore (_)",
    B: "At sign (@)",
    C: "Hyphen (-)",
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "15 ÷ 3 = 5 and 15 ÷ 5 = 3, so 15 is divisible by both.",
},
{
  id:  613,
  subject: "English",
  question: "Which word is correctly used as a noun in:  'Honesty is a virtue.'?",
  options: {
    A: "Honesty",
    B: "virtue",
    C: "is",
...
},
{
  id:  615,
  subject: "Science & Technology",
  question:  "Which process produces carbon dioxide as a waste product in living cells?",
  options: {
    A: "Photosynthesis",
...
},
{
  id:  617,
  subject: "CRE",
  question:  "Which animal is associated with the symbol of strength in the Bible?",
  options: {
    A: "Lamb",
    B: "Lion",
    C: "Dove",
...
},
{
  id:  622,
  subject: "ICT/Computer Studies",
  question: "Which device allows a computer to communicate wirelessly with the internet?",
  options: {
    A: "Modem",
    B: "WiFi router",
    C: "Printer",
...
},
{
  id: 623,
  subject:  "Mathematics",
  question: "What is the volume of a rectangular box with length 4 cm, width 3 cm and height 5 cm?",
  options:  {
    A: "60 cm³",
    B:  "50 cm³",
    C:  "45 cm³",
...
},
{
  id:  626,
  subject: "Science & Technology",
  question:  "Which part of a cell controls all activities and contains genetic material?",
  options:  {
    A: "Mitochondria",
    B: "Ribosome",
    C: "Nucleus",
...
},
{
  id:  635,
  subject: "English",
  question: "Which word is an adjective modifying 'house' in:  'She lives in a beautiful house.'?",
  options: {
    A: "lives",
    B: "beautiful",
    C: "house",
...
},
{
  id: 639,
  subject: "CRE",
  question: "Which action did Zacchaeus the tax collector do to make amends for his wrongs?",
  options: {
...
},
{
  id: 640,
  subject:  "Agriculture",
  question: "Which benefit does crop rotation provide besides disease control?",
  options: {
...
},
{
  id: 651,
  subject: "Agriculture",
  question: "Which animal is used to improve soil fertility by leaving droppings?",
  options:  {
    A: "Birds",
...
},
{
  id: 655,
  subject: "ICT/Computer Studies",
  question:  "Which key combination selects all items in a folder or document?",
  options: {
    A: "Ctrl + A",
    B: "Ctrl + D",
    C: "Ctrl + L",
...
},
{
  id:  656,
  subject: "Mathematics",
  question: "If a student scores 80, 85 and 90 on three tests, what is the average?",
  options: {
    A: "85",
    B: "90",
    C: "75",
...
},
{
  id: 661,
  subject: "CRE",
  question: "Which teaching emphasises treating others how you wish to be treated?",
  options: {
...
},
{
  id: 664,
  subject:  "Home Science",
  question:  "Which utensil material is best for non-stick cooking without harmful chemicals?",
  options: {
...
},
{
  id: 666,
  subject:  "ICT/Computer Studies",
  question: "Which term describes the physical devices that make up a computer?",
  options:  {
    A: "Software",
    B: "Hardware",
    C: "Firmware",
...
},
{
  id: 668,
  subject: "English",
  question: "Which word is a pronoun in the sentence:  'He gave the book to her.'?",
  options: {
    A: "gave",
    B: "book",
    C: "he",
...
},
{
  id: 669,
  subject:  "Kiswahili",
  question: "Chagua sahihi:  'Alikuwa anataka ___ chakula kwa sababu alikuwa na njaa.'",
  options: {
    A: "kula",
    B: "kulya",
    C: "nakula",
...
},
{
  id: 672,
  subject: "CRE",
  question: "Which miracle is unique to the Gospel of John among the first three Gospels?",
  options:  {
    A: "Feeding the five thousand",
...
},
{
  id: 674,
  subject:  "Music",
  question: "Which musical form is a piece with a recurring melody (A) alternating with new sections? ",
  options: {
    A: "Rondo form (ABACA)",
    B: "Sonata form",
    C: "Fugue",
...
},
{
  id: 683,
  subject: "CRE",
  question: "Which action did Peter deny three times according to the Gospel accounts?",
  options: {
    A: "Knowing Jesus",
    B: "Believing in God",
    C: "Being a disciple",
...
},
{
  id: 685,
  subject:  "Music",
  question: "Which instrument is typically the lead instrument in a brass band?",
  options: {
    A: "French horn",
    B: "Trumpet",
    C: "Tuba",
...
},
{
  id: 694,
  subject: "CRE",
  question: "Which sacrament involves the anointing of the sick in Christian practice?",
  options: {
    A: "Baptism",
    B: "Communion",
...
},
{
  id: 696,
  subject:  "Music",
  question: "Which symbol indicates to hold a note longer than its written value?",
  options: {
    A: "Fermata (𝄐)",
    B: "Staccato dot",
    C: "Natural sign",
...
},
{
  id: 697,
  subject: "Home Science",
  question: "Which fabric material requires gentle washing to maintain quality?",
  options: {
    A: "Silk and wool",
    B: "Cotton and linen",
    C: "Polyester",
...
},
{
  id: 699,
  subject: "ICT/Computer Studies",
  question: "Which file format is best for sharing documents that shouldn't be edited easily?",
  options: {
    A: "PDF",
    B: "DOCX",
    C: "TXT",
...
},
{
  ...
  id: 701,
  subject:  "English",
  question: "Which word is a conjunction in:   'She studied hard and passed the exam.'? ",
  options: {
    A: "studied",
    B: "hard",
    C: "and",
...
},
{
  id: 706,
  subject: "CRE",
  question: "Which teaching warns against the love of money in Christian faith?",
  options: {
    A: "'Money is evil'",
...
},
{
  id: 707,
  subject: "Agriculture",
  question: "Which practice helps improve soil structure and water retention?",
  options:  {
...
},
{
  id: 717,
  subject: "CRE",
  question: "Which virtue is shown when a person forgives someone who wronged them?",
  options:  {
    A: "Revenge",
    B: "Anger",
    C: "Forgiveness",
...
},
{
  ...
  correctAnswer:  "C",
  explanation: 
    "Soprano is the highest vocal range, typically female voices.",
},
{
  id: 720,
  subject:  "Home Science",
...
},
{
  id: 721,
  subject: "Physical & Health Education",
  question: "Which is an appropriate cool-down activity after intense exercise?",
  options: {
...
},
{
  id: 722,
  subject: "ICT/Computer Studies",
  question: "Which view in a spreadsheet allows you to see formulas instead of results?",
  options: {
    A: "Normal view",
    B: "Formula view",
    C: "Page view",
...
},
{
  id: 723,
  subject:  "Mathematics",
  question: "If you have 24 marbles and divide them equally among 6 friends, how many does each get?",
  options: {
    A: "3",
    B: "4",
    C: "5",
  ...
  correctAnswer:  "B",
  explanation:
    "Divide 24 by 6: 24 ÷ 6 = 4 marbles per friend.",
},
{
  id: 724,
  subject: "English",
  question: "Which word is an article in the sentence:  'I saw a beautiful rainbow.'?",
  options: {
    A: "saw",
    B: "beautiful",
    C: "a",
...
},
{
  id: 732,
  subject:  "Physical & Health Education",
  question: "Which type of exercise improves flexibility and reduces muscle tension?",
  options: {
    A: "Weight lifting",
...
},
{
  ...
  correctAnswer: "C",
  explanation: 
    "'Definitely' is the correct spelling with '-ite' and '-ly'.",
},
{
  id: 736,
  subject:  "Kiswahili",
...
},
{
  id: 739,
  subject: "CRE",
  question: "Which Christian practice involves gathering regularly to worship and pray?",
  options: {
    A: "Fasting only",
    B: "Church attendance",
...
},
{
  id: 740,
  subject: "Agriculture",
  question: "Which sign indicates that a fruit is ripe and ready for harvest?",
  options: {
    A: "Green colour only",
...
},
{
  ...
  correctAnswer: "C",
  explanation: 
    "Fortissimo (ff) directs musicians to play very loudly.",
},
{
  id:  742,
  subject: "Home Science",
...
},
{
  id: 744,
  subject: "ICT/Computer Studies",
  question: "Which term describes converting data into unreadable code for security?",
  options: {
    A: "Decryption",
    B: "Encryption",
    C: "Compression",
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "PEMDAS ensures consistent mathematical calculation order.",
},
{
  id: 746,
  subject: "English",
  ...
  correctAnswer: "B",
  explanation:
    "Proper nouns like place names are capitalized:  'New York'.",
},
{
  id: 747,
  subject: "Kiswahili",
...
},
{
  id: 751,
  subject: "Agriculture",
  question:  "Which farming system integrates crops and livestock for maximum efficiency?",
  options: {
    A: "Monoculture",
    B:  "Mixed farming",
...
},
{
  ...
  correctAnswer:  "D",
  explanation:
    "Bass is the lowest male vocal range in a choir.",
},
{
  id:  753,
  subject: "Home Science",
...
},
{
  id: 754,
  subject: "Physical & Health Education",
  question: "Which activity best helps develop balance and coordination in children?",
  options: {
    A: "Video games",
...
},
{
  id:  757,
  subject: "English",
  question: "Which word is a determiner in:   'Those children are very intelligent.'? ",
  options: {
    A: "children",
    B: "are",
    C: "Those",
...
},
{
  id:  761,
  subject: "CRE",
  question:  "Which biblical figure is known for his faith despite life's challenges?",
  options:  {
    A: "Job",
    B: "Judas",
    C: "Goliath",
...
},
{
  ...
  correctAnswer:  "A",
  explanation:
    "Handwashing removes germs and prevents foodborne illness.",
},
{
  id: 765,
  subject: "Physical & Health Education",
...
},
{
  id: 767,
  subject:  "Mathematics",
  question: "What is the sum of angles in a quadrilateral (four-sided shape)?",
  options: {
    A: "180°",
    B: "270°",
    C: "360°",
...
},
{
  id: 770,
  subject: "Science & Technology",
  question: "Which gas do animals exhale that plants need for photosynthesis?",
  options: {
    A: "Oxygen",
    B: "Nitrogen",
    C: "Carbon dioxide",
...
},
{
  id: 774,
  subject:  "Music",
  question: "Which notation symbol indicates a note should be played shorter?",
  options: {
    A: "Staccato dot (·)",
    B: "Fermata",
    C: "Slur",
...
},
{
  id: 775,
  subject: "Home Science",
  question: "Which is the recommended daily water intake for a healthy adult?",
  options: {
    A: "1 glass",
...
},
{
  id:  782,
  subject: "Social Studies",
  question: "Which institution is responsible for educating the youth of a nation?",
  options: {
...
},
{
  id: 783,
  subject:  "CRE",
  question: "Which Christian sacrament marks the beginning of Christian life?",
  options: {
    A: "Communion",
    B: "Baptism",
    C: "Confirmation",
...
},
{
  id: 784,
  subject:  "Agriculture",
  question: "Which factor affects the choice of crop for a particular region?",
  options: {
...
},
{
  id:  790,
  subject: "English",
  question: "Which word is a verb in the infinitive form:   'I want to run quickly.'? ",
  options: {
    A: "want",
    B: "quickly",
    C: "to run",
  ...
  correctAnswer:  "C",
  explanation:
    "'To run' is the infinitive form of the verb.",
},
{
  id:  791,
  subject: "Kiswahili",
...
},
{
  id: 794,
  subject: "CRE",
  question: "Which sin is warned against in the parable of the Rich Man and Lazarus?",
  options: {
  ...
  correctAnswer: "A",
  explanation:
    "The parable warns against greed and ignoring those in need.",
},
{
  id: 795,
  subject: "Agriculture",
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "Proper reheating kills bacteria and ensures food safety.",
},
{
  id: 798,
  subject: "Physical & Health Education",
...
},
{
  ...
  id: 801,
  subject:  "English",
  question: "Which word is a noun in the sentence: 'The brown dog barked loudly.'?",
  options: {
    A: "brown",
    B: "dog",
    C: "barked",
...
},
{
  ...
  correctAnswer: "C",
  explanation:
    "Add from left to right: 5 + 8 = 13, then 13 + 7 = 20.",
},
{
  id:  803,
  subject: "Kiswahili",
...
},
{
  id: 810,
  subject: "Physical & Health Education",
  question: "Which is the proper position for sitting at a desk to prevent back pain?",
  options: {
    A: "Slouched forward",
    B: "Lying back fully",
...
},
{
  id: 811,
  subject:  "ICT/Computer Studies",
  question: "Which keyboard shortcut deletes the character before the cursor?",
  options:  {
    A: "Delete",
    B: "Backspace",
    C: "Tab",
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "Multiply 10 by 0.5 (which equals 1/2): 10 × 0.5 = 5.",
},
{
  id: 813,
  subject: "English",
  question: "Which word is an adverb modifying 'walked' in:  'She walked slowly down the street.'?",
  options: {
    A: "down",
    B: "street",
    C: "slowly",
...
},
{
  id: 815,
  subject: "Science & Technology",
  question: "Which type of material allows electricity to flow through it easily?",
  options: {
    A: "Insulator",
    B: "Conductor",
    C: "Semiconductor",
...
},
{
  id: 816,
  subject:  "Social Studies",
  question:  "Which organization helps provide clean water to communities worldwide?",
  options: {
    A: "UNICEF",
    B: "Local bakery",
    C: "Sports club",
...
},
{
  id: 817,
  subject: "CRE",
  question: "Which teaching emphasizes treating the sick and poor as Jesus himself?",
  options: {
    A: "Avoid the poor",
...
},
{
  id: 818,
  subject:  "Agriculture",
  question: "Which practice helps prevent soil compaction from heavy machinery?",
  options:  {
...
},
{
  ...
  correctAnswer:  "C",
  explanation: 
    "The oboe uses a double reed and is a woodwind instrument.",
},
{
  id: 820,
  subject: "Home Science",
  question: "Which cooking method uses steam under pressure to cook food faster?",
  options: {
    A: "Pressure cooking",
    B: "Boiling",
    C: "Roasting",
...
},
{
  id: 828,
  subject: "CRE",
  question: "Which Christian denomination emphasizes salvation through faith in Jesus? ",
  options: {
    A: "Buddhism",
    B: "Islam",
...
},
{
  id: 841,
  subject: "Music",
  question: "Which musical form is structured as ABA (theme, variation, return)?",
  options: {
    A: "Rondo",
    B: "Ternary form",
    C: "Fugue",
...
},
{
  id: 842,
  subject: "Home Science",
  question: "Which nutrient is essential for building strong bones and teeth?",
  options: {
    A: "Protein",
    B: "Calcium",
    C: "Fat",
...
},
{
  id:  843,
  subject: "Physical & Health Education",
  question: "Which exercise targets the hamstring muscles at the back of the thigh?",
  options: {
    A: "Push-ups",
    B: "Leg curls",
    C: "Shoulder raises",
  ...
  correctAnswer: "B",
  explanation:
    "Leg curls directly exercise the hamstring muscles.",
},
{
  id:  844,
  subject: "ICT/Computer Studies",
  question: "Which is the proper way to safely eject a USB drive from a computer?",
  options:  {
...
},
{
  ...
  correctAnswer: "A",
  explanation:
    "Range = highest value minus lowest value = 15 - 5 = 10.",
},
{
  id: 846,
  subject: "English",
  question: "Which word is a preposition in:  'The cat sat beneath the tree.'?",
  options: {
    A: "sat",
    B: "beneath",
    C: "cat",
  ...
  correctAnswer:  "B",
  explanation:
    "'Beneath' shows the relationship between 'cat' and 'tree'.",
},
{
  id: 847,
  subject: "Kiswahili",
  ...
  correctAnswer: "B",
  explanation:
    "'Jina lako nani?' directly asks 'What is your name? '",
},
{
  id: 848,
  subject: "Science & Technology",
...
},
{
  id: 850,
  subject: "CRE",
  question: "Which action did Jesus tell his followers to do to remember him?",
  options: {
    A: "Build monuments",
...
},
{
  id:  851,
  subject: "Agriculture",
  question: "Which is the best season to plant crops in most tropical regions?",
  options: {
    A: "Dry season only",
    B: "Rainy season",
    C: "Winter season",
...
},
{
  id: 852,
  subject: "Music",
  question: "Which instrument is the largest and plays the lowest notes in the orchestra?",
  options: {
    A: "Violin",
    B: "Cello",
    C: "Double bass",
...
},
{
  id: 861,
  subject:  "CRE",
  question: "Which virtue is displayed when a person lives according to their religious beliefs?",
  options: {
    A: "Hypocrisy",
    B:  "Insincerity",
    C: "Faithfulness",
...
},
{
  id:  863,
  subject: "Music",
  question: "Which is the middle range of the human voice (typically female)?",
  options: {
    A: "Soprano",
    B: "Alto",
    C: "Tenor",
...
},
{
  id: 865,
  subject: "Physical & Health Education",
  question:  "Which food combination provides complete nutrition for a child's growth?",
  options: {
    A: "Only sweets",
  ...
  correctAnswer: "B",
  explanation:
    "Balanced meals with variety support growth and development.",
},
{
  id: 866,
  subject: "ICT/Computer Studies",
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "3 and 7 are coprime; their LCM = 3 × 7 = 21.",
},
{
  id: 868,
  subject: "English",
  ...
  correctAnswer: "B",
  explanation:
    "'Run' is the main verb expressing the action.",
},
{
  id:  869,
  subject: "Kiswahili",
...
},
{
  id: 879,
  subject: "English",
  question: "Which word functions as an adjective in: 'The old man walked slowly.'?",
  options: {
    A: "walked",
    B: "old",
    C: "slowly",
  ...
  correctAnswer: "B",
  explanation:
    "'Old' describes the noun 'man', functioning as an adjective.",
},
{
  id: 880,
  subject: "Kiswahili",
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "Pitch determines whether a note sounds high or low.",
},
{
  id:  886,
  subject: "Home Science",
...
},
{
  id: 887,
  subject:  "Physical & Health Education",
  question: "Which is a common cause of sports-related injuries in young athletes?",
  options: {
  ...
  correctAnswer: "C",
  explanation:
    "Poor warm-up and pushing too hard increase injury risk.",
},
{
  id: 888,
  subject: "ICT/Computer Studies",
...
},
{
  id: 890,
  subject:  "English",
  question: "Which sentence uses the correct form of 'to be' in the past tense?",
  options:  {
  ...
  correctAnswer: "B",
  explanation:
    "With plural 'they', the past form is 'were' not 'was'.",
},
{
  id: 891,
  subject: "Kiswahili",
...
},
{
  id: 894,
  subject: "CRE",
  question: "Which Christian principle teaches that all people are made in God's image?",
  options: {
...
},
{
  ...
  correctAnswer: "C",
  explanation:
    "A quarter note receives one beat in common (4/4) time.",
},
{
  id: 897,
  subject: "Home Science",
  ...
  correctAnswer: "B",
  explanation:
    "Balanced meals include nutrients from all food groups.",
},
{
  id:  898,
  subject: "Physical & Health Education",
  ...
  correctAnswer: "B",
  explanation:
    "Proper form prevents injury and maximises muscle engagement.",
},
{
  id: 899,
  subject:  "ICT/Computer Studies",
...
},
{
  ...
  correctAnswer: "B",
  explanation:
    "2/3 × 30 = (2 × 30) ÷ 3 = 60 ÷ 3 = 20.",
},{
  id: 901,
  subject:   "English",
  question: "Which word is a verb in the sentence:  'The children are building a sandcastle.'?",
  options: {
    A: "children",
    B: "building",
    C: "sandcastle",
...
},
{
  ...
  correctAnswer:  "C",
  explanation: 
    "Add from left to right: 50 + 25 = 75, then 75 + 10 = 85.",
},
{
  id:   903,
  subject: "Kiswahili",
...
},
{
  ...
  correctAnswer: "B",
  explanation:  
    "Jesus taught unconditional love, including love for enemies.",
},
{
  id: 907,
  subject:   "Agriculture",
...
},
{
  ...
  correctAnswer: "C",
  explanation:
    "Fresh bread has a soft texture, good smell and no mould.",
},
{
  id: 910,
  subject:  "Physical & Health Education",
...
},
{
  id: 913,
  subject: "English",
  question: "Which word is a noun in:  'The beautiful flower bloomed in spring.'?",
  options: {
    A: "beautiful",
    B: "bloomed",
    C: "flower",
...
},
{
  id: 918,
  subject:  "Agriculture",
  question: "Which is an advantage of using organic manure instead of chemicals only?",
  options:   {
...
},
{
  id: 919,
  subject:  "Music",
  question: "Which musical element describes the pattern of strong and weak beats?",
  options:  {
    A: "Harmony",
    B: "Melody",
    C: "Rhythm",
...
},
{
  id: 921,
  subject:  "Physical & Health Education",
  question: "Which is a common effect of regular physical activity on the heart?",
  options: {
...
},
{
  ...
  correctAnswer: "C",
  explanation: 
    "'Receive' is spelled with 'ei' not 'ie'.",
},
{
  id: 925,
  subject: "Kiswahili",
...
},
{
  ...
  correctAnswer: "B",
  explanation:  
    "Kidneys filter waste and excess water to produce urine.",
},
{
  id: 927,
  subject:  "Social Studies",
...
},
{
  id: 930,
  subject: "Music",
  question:  "Which musical notation indicates a note should be held beyond its normal value?",
  options: {
    A: "Fermata",
    B: "Staccato",
    C: "Accent",
  ...
  correctAnswer: "A",
  explanation: 
    "A fermata symbol tells the musician to hold a note longer.",
},
{
  id:  931,
  subject: "Home Science",
...
},
{
  ...
  correctAnswer: "C",
  explanation:  
    "Multiple backup locations protect against data loss.",
},
{
  id: 934,
  subject: "Mathematics",
...
},
{
  ...
  correctAnswer: "B",
  explanation:  
    "High pressure systems typically bring clear, stable weather.",
},
{
  id: 938,
  subject: "Social Studies",
...
},
{
  id: 939,
  subject: "CRE",
  question: "Which virtue is shown when someone forgives after being wronged?",
  options: {
    A: "Revenge",
    B: "Anger",
    C: "Mercy",
...
},
{
  ...
  correctAnswer: "C",
  explanation: 
    "'Oh' expresses emotion and functions as an interjection.",
},
{
  id: 947,
  subject: "Kiswahili",
...
},
{
  ...
  correctAnswer: "C",
  explanation: 
    "The lens fine-tunes focus after initial corneal focusing.",
},
{
  id: 949,
  subject:  "Social Studies",
...
},
{
  id: 950,
  subject: "CRE",
  question: "Which account in the Bible shows God's patience with human weakness?",
  options: {
...
},
{
  id: 951,
  subject: "Agriculture",
  question:  "Which is an advantage of intercropping (planting multiple crops together)?",
  options: {
...
},
{
  ...
  correctAnswer: "B",
  explanation: 
    "Mezzo-forte is medium loudness, between soft and loud.",
},
{
  id: 953,
  subject: "Home Science",
...
},
{
  ...
  correctAnswer: "B",
  explanation:  
    "Calculate left to right: 12 − 8 = 4, then 4 + 5 = 9.",
},
{
  id: 957,
  subject: "English",
...
},
{
  ...
  correctAnswer: "B",
  explanation: 
    "Courts interpret and enforce laws; police enforce them.",
},
{
  id: 961,
  subject:  "CRE",
  question: "Which teaching emphasises serving others without expecting reward?",
  options:  {
  ...
  correctAnswer: "B",
  explanation: 
    "Christian teaching emphasises selfless service and humility.",
},
{
  id: 962,
  subject: "Agriculture",
...
},
{
  ...
  correctAnswer: "B",
  explanation:  
    "Gentle hand-washing protects delicate fibres from damage.",
},
{
  id: 965,
  subject: "Physical & Health Education",
...
},
{
  ...
  correctAnswer:  "B",
  explanation: 
    "Scanning files reduces the risk of malware infection.",
},
{
  id: 967,
  subject:  "Mathematics",
  ...
  correctAnswer: "A",
  explanation: 
    "Convert to common denominator 6: (2/6) + (1/6) = 3/6 = 1/2.",
},
{
  id: 968,
  subject: "English",
  question: "Which word is used as a conjunction in:  'She studied hard yet failed the test.'?",
  options: {
    A: "studied",
    B: "hard",
    C: "yet",
  ...
  correctAnswer: "C",
  explanation: 
    "'Yet' connects two independent clauses showing contrast.",
},
{
  id:  969,
  subject: "Kiswahili",
...
},
{
  id: 971,
  subject:  "Social Studies",
  question:  "Which is a traditional conflict resolution method in many communities?",
  options: {
...
},
{
  id: 973,
  subject: "Agriculture",
  question:  "Which pest control method uses insects to control other insects?",
  options: {
...
},
{
  ...
  correctAnswer: "B",
  explanation: 
    "Area = (base × height) ÷ 2 = (8 × 6) ÷ 2 = 24 cm².",
},
{
  id: 979,
  subject: "English",
  question:  "Which word is a verb in the infinitive form:  'I want to run fast.'?",
  options: {
    A: "want",
    B: "fast",
    C: "to run",
...
},
{
  id: 983,
  subject: "CRE",
  question: "Which biblical story teaches the value of persistence in prayer?",
  options: {
...
},
{
  ...
  correctAnswer: "B",
  explanation: 
    "Herbs and spices add flavour with minimal salt or sugar.",
},
{
  id: 987,
  subject: "Physical & Health Education",
  ...
  correctAnswer: "B",
  explanation:  
    "Yoga and Pilates focus on alignment and core engagement.",
},
{
  id: 988,
  subject:  "ICT/Computer Studies",
...
},
{
  ...
  correctAnswer: "A",
  explanation: 
    "Calculate left to right: 8 + 7 = 15, then 15 − 3 = 12.",
},
{
  id: 990,
  subject: "English",
  question: "Which word is an adverb modifying an adjective in:  'That test was extremely difficult.'?",
  options: {
    A: "that",
    B: "test",
    C: "extremely",
...
},
{
  id: 994,
  subject:  "CRE",
  question: "Which action shows hope in difficult times according to Christian faith?",
  options: {
...
},
{
  id: 995,
  subject:  "Agriculture",
  question: "Which method helps preserve fresh vegetables for several months?",
  options: {
...
},
{
  id: 996,
  subject: "Music",
  question: "Which musical form consists of a single melodic line without accompaniment?",
  options: {
    A: "Homophony",
    B: "Polyphony",
    C: "Monophony",
  ...
  correctAnswer: "C",
  explanation: 
    "Monophony is a single melody sung or played without harmony.",
},
{
  id: 997,
  subject:  "Home Science",
  question:  "Which is a proper way to prepare vegetables to preserve nutrients?",
  options: {
...
},
{
...
},
  {
    ...
    "correctAnswer": "C",
    "explanation": "In Euclidean geometry, the sum of the interior angles of any triangle is always equal to 180."
  },
  {
    "id": 1002,
    "subject": "English",
    ...
    "correctAnswer": "B",
    "explanation": "When using pronouns as subjects, 'He' and 'I' are the correct subject pronouns. It is also polite to put the other person before yourself ('He and I')."
  },
  {
    "id": 1003,
    "subject": "Kiswahili",
    "question": "Tegua kitendawili hiki: 'Nyumba yangu haina mlango wala dirisha.'",
    "options": {
      "A": "Chungwa",
      "B": "Nanasi",
      "C": "Yai",
    ...
    "correctAnswer": "C",
    "explanation": "Yai ni kitu kilichofungwa pande zote bila nafasi ya wazi (kama mlango au dirisha) hadi kipasuliwe."
  },
  {
    "id": 1004,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "B",
    "explanation": "In a wheelbarrow, the load is between the fulcrum (wheel) and the effort (handles). This is the definition of a second-class lever."
  },
  {
    "id": 1005,
    "subject": "Social Studies",
    ...
    "correctAnswer": "B",
    "explanation": "The Deputy County Commissioner (DCC) is the national government representative in charge of a Sub-County. The County Commissioner heads the County."
  },
  {
    "id": 1006,
    "subject": "CRE",
    ...
    "correctAnswer": "C",
    "explanation": "The Parable of the Prodigal Son illustrates God's boundless mercy and readiness to forgive those who repent and return to Him."
  },
  {
    "id": 1007,
    "subject": "Agriculture",
    ...
    "correctAnswer": "C",
    "explanation": "Tuber crops grow underground. Sweet potatoes, irish potatoes, and yams are examples of tubers. Maize and wheat are cereals; beans are legumes."
  },
  {
    "id": 1008,
    "subject": "Music",
    ...
    "correctAnswer": "B",
    "explanation": "The Kenyan National Anthem consists of three verses, which are usually sung in either Kiswahili or English during official functions."
  },
  {
    "id": 1009,
    "subject": "Home Science",
    ...
    "correctAnswer": "C",
    "explanation": "During puberty/pre-adolescence, boys experience a deepening of the voice (breaking voice) due to the enlargement of the larynx."
  },
  {
    "id": 1010,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "C",
    "explanation": "Field events involve jumping or throwing (e.g., Long Jump, Shot Put, Javelin). Track events involve running on the track (e.g., Sprints, Relays)."
  },
  {
    "id": 1011,
    "subject": "ICT/Computer Studies",
    "question": "Which bar at the top of a window displays the name of the document or program?",
    "options": {
      "A": "Status Bar",
      "B": "Scroll Bar",
      "C": "Title Bar",
    ...
    "correctAnswer": "C",
    "explanation": "The Title Bar is located at the very top of an application window and shows the name of the file and the program being used."
  },
  {
    "id": 1012,
    "subject": "Mathematics",
    ...
    "correctAnswer": "C",
    "explanation": "First, find a common denominator, which is 8. Convert $3/4$ to eighths: $3/4 = 6/8$. Now subtract: $6/8 - 1/8 = 5/8$."
  },
  {
    "id": 1013,
    "subject": "English",
    "question": "Choose the correct homophone to complete the sentence: 'They went to ___ house.'",
    "options": {
      "A": "There",
      "B": "Their",
      "C": "They're",
    ...
    "correctAnswer": "B",
    "explanation": "'Their' is the possessive form indicating ownership. 'There' indicates place, and 'They're' is a contraction of 'They are'."
  },
  {
    "id": 1014,
    "subject": "Kiswahili",
    ...
    "correctAnswer": "B",
    "explanation": "Ndama ni jina la mtoto wa ng'ombe. Kinda ni la ndege, na kifaranga ni la kuku."
  },
  {
    "id": 1015,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "C",
    "explanation": "The Large Intestine (colon) absorbs water and salts from the material that has not been digested as food, and gets rid of any waste products left over."
  },
  {
    "id": 1016,
    "subject": "Social Studies",
    "question": "The main line of latitude that divides the Earth into the Northern and Southern Hemispheres is called the:",
    "options": {
      "A": "Prime Meridian",
      "B": "Equator",
      "C": "Tropic of Cancer",
    ...
    "correctAnswer": "B",
    "explanation": "The Equator is the imaginary line at $0$ degrees latitude, equidistant from the North and South Poles, dividing the Earth into North and South."
  },
  {
    "id": 1017,
    "subject": "CRE",
    ...
    "correctAnswer": "C",
    "explanation": "Saul was the first king anointed by the prophet Samuel to lead the Israelites, before David and Solomon."
  },
  {
    "id": 1018,
    "subject": "Agriculture",
    "question": "Which tool is used for cutting tall grass or harvesting cereal crops like wheat manually?",
    "options": {
      "A": "Rake",
      "B": "Slasher",
      "C": "Sickle",
    ...
    "correctAnswer": "C",
    "explanation": "A sickle has a curved blade and is specifically designed for harvesting, or reaping, grain crops or cutting succulent forage."
  },
  {
    "id": 1019,
    "subject": "Music",
    ...
    "correctAnswer": "C",
    "explanation": "The major scale sequence is: Do, Re, Mi, Fa, So, La, Ti, Do. Therefore, 'Fa' follows 'Mi'."
  },
  {
    "id": 1020,
    "subject": "Home Science",
    "question": "Which common household item is an abrasive cleaner used for scrubbing pots?",
    "options": {
      "A": "Steel wool",
      "B": "Sponge",
      "C": "Cotton cloth",
    ...
    "correctAnswer": "A",
    "explanation": "Steel wool is made of fine metal fibers and is abrasive, making it effective for scrubbing burnt food or tough stains off metal pots (aluminum/steel)."
  },
  {
    "id": 1021,
    "subject": "Physical & Health Education",
    "question": "What is the standard number of players on a Volleyball court for one team?",
    "options": {
      "A": "5",
      "B": "6",
      "C": "7",
    ...
    "correctAnswer": "B",
    "explanation": "A standard volleyball team consists of 6 players on the court at any one time."
  },
  {
    "id": 1022,
    "subject": "ICT/Computer Studies",
    "question": "Which key allows you to exit a full-screen mode or cancel a command?",
    "options": {
      "A": "Enter",
      "B": "Esc (Escape)",
      "C": "Shift",
    ...
    "correctAnswer": "B",
    "explanation": "The 'Esc' (Escape) key is used to interrupt a current function, close a pop-up menu, or exit full-screen mode."
  },
  {
    "id": 1023,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "In the decimal 6.145, 1 is in the tenths place, 4 is in the hundredths place ($0.04$), and 5 is in the thousandths place."
  },
  {
    "id": 1024,
    "subject": "English",
    "question": "Identify the abstract noun in this sentence: 'His honesty was admired by everyone.'",
    "options": {
      "A": "His",
      "B": "Honesty",
      "C": "Admired",
    ...
    "correctAnswer": "B",
    "explanation": "An abstract noun refers to an idea, quality, or state rather than a concrete object. 'Honesty' is a quality."
  },
  {
    "id": 1025,
    "subject": "Kiswahili",
  ...
  },
  {
    "id": 1026,
    "subject": "Science & Technology",
    "question": "Which of these clouds are associated with heavy rain and thunderstorms?",
    "options": {
      "A": "Cirrus",
      "B": "Cumulus",
      "C": "Cumulonimbus",
    ...
    "correctAnswer": "C",
    "explanation": "Cumulonimbus clouds are tall, dense, and dark clouds often called 'thunderheads' that produce heavy rain, lightning, and thunder."
  },
  {
    "id": 1027,
    "subject": "Social Studies",
    ...
    "correctAnswer": "B",
    "explanation": "The Mau Mau uprising was a rebellion against British colonial rule, specifically fighting to recover stolen land and gain independence (freedom)."
  },
  {
    "id": 1028,
    "subject": "CRE",
    "question": "Which Fruit of the Holy Spirit helps us to wait calmly without complaining?",
    "options": {
      "A": "Joy",
      "B": "Kindness",
      "C": "Patience",
    ...
    "correctAnswer": "C",
    "explanation": "Patience (or Long-suffering) is the virtue of enduring difficult circumstances or waiting without becoming annoyed or anxious."
  },
  {
    "id": 1029,
    "subject": "Agriculture",
    ...
    "correctAnswer": "C",
    "explanation": "Terracing involves creating flat steps on a slope to slow down water runoff and prevent soil from being washed away. Ploughing up and down encourages erosion."
  },
  {
    "id": 1030,
    "subject": "Music",
    ...
    "correctAnswer": "A",
    "explanation": "The Nyatiti is a traditional Kenyan lyre (string instrument) played by plucking. Kayamba is a shaker (percussion), Drum is percussion, Horn is wind."
  },
  {
    "id": 1031,
    "subject": "Home Science",
    ...
    "correctAnswer": "C",
    "explanation": "Anaemia is a condition caused by a deficiency of red blood cells or hemoglobin, often due to a lack of iron in the diet."
  },
  {
    "id": 1032,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "C",
    "explanation": "Leaning forward prevents blood from flowing down the throat (which can cause vomiting), and pinching helps stop the bleeding by applying pressure."
  },
  {
    "id": 1033,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "C",
    "explanation": "A monitor displays the results of the computer's processing to the user visually. Scanners, microphones, and webcams are input devices."
  },
  {
    "id": 1034,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "1 hour = 60 minutes. 3 hours = 3 times 60 = 180 text minutes. 180 + 20 = 200 minutes."
  },
  {
    "id": 1035,
    "subject": "English",
    ...
    "correctAnswer": "B",
    "explanation": "Gigantic means of very great size or extent; huge or enormous."
  },
  {
    "id": 1036,
    "subject": "Kiswahili",
    ...
    "correctAnswer": "B",
    "explanation": "'Shikamoo' ni salamu ya heshima kwa mtu mkubwa kiumri. Jibu lake rasmi ni 'Marahaba'."
  },
  {
    "id": 1037,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "C",
    "explanation": "The skeleton provides the framework that supports the body's shape and protects vital internal organs (e.g., skull protects brain, ribs protect heart)."
  },
  {
    "id": 1038,
    "subject": "Social Studies",
    ...
    "correctAnswer": "C",
    "explanation": "Black represents the indigenous people of Kenya. Red stands for blood shed for independence, Green for the land, and White for peace."
  },
  {
    "id": 1039,
    "subject": "CRE",
    ...
    "correctAnswer": "B",
    "explanation": "David, though small and young, defeated the giant Goliath because he trusted in God, teaching that faith conquers fear and seemingly impossible odds."
  },
  {
    "id": 1040,
    "subject": "Agriculture",
    "question": "Which type of irrigation involves using pipes with small holes to drip water near the plant roots?",
    "options": {
      "A": "Flood irrigation",
    ...
    "correctAnswer": "C",
    "explanation": "Drip irrigation is a water-efficient method where water drips slowly to the roots of plants, minimizing evaporation and water wastage."
  },
  {
    "id": 1041,
    "subject": "Music",
    ...
    "correctAnswer": "B",
    "explanation": "A choir is an organized group of singers, typically one that takes part in church services or performs in public."
  },
  {
    "id": 1042,
    "subject": "Home Science",
    "question": "Why should we separate coloured clothes from white clothes before washing?",
    "options": {
      "A": "To save soap",
    ...
    "correctAnswer": "B",
    "explanation": "Coloured fabrics can 'bleed' dye during washing. If mixed with whites, the whites will get stained or discoloured."
  },
  {
    "id": 1043,
    "subject": "Physical & Health Education",
    "question": "In the game of Netball, how many seconds can a player hold the ball?",
    "options": {
      "A": "10 seconds",
      "B": "3 seconds",
      "C": "5 seconds",
    ...
    "correctAnswer": "B",
    "explanation": "In standard Netball rules, a player must release the ball (pass or shoot) within 3 seconds of receiving it."
  },
  {
    "id": 1044,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Facebook is a social networking service where users can connect, share, and communicate. The others are offline utility/productivity software."
  },
  {
    "id": 1045,
    "subject": "Mathematics",
    "question": "A car travels at a speed of 60 km/h. How far will it travel in 2 hours?",
    "options": {
      "A": "30 km",
      "B": "120 km",
      "C": "62 km",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "'Under' is the correct preposition of place to describe something being directly below or covered by something else."
  },
  {
    "id": 1047,
    "subject": "Kiswahili",
  ...
  },
  {
    "id": 1048,
    "subject": "Science & Technology",
    "question": "What is the force that opposes motion between two surfaces touching each other?",
    "options": {
      "A": "Gravity",
      "B": "Magnetism",
      "C": "Friction",
    ...
    "correctAnswer": "C",
    "explanation": "Friction is the resistance that one surface or object encounters when moving over another. It slows things down."
  },
  {
    "id": 1049,
    "subject": "Social Studies",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "The Lord's Prayer (Our Father) is the central prayer in Christianity, given by Jesus as a model for how to pray."
  },
  {
    "id": 1051,
    "subject": "Agriculture",
    ...
    "correctAnswer": "B",
    "explanation": "Poultry refers to domesticated birds kept for meat or eggs. Turkeys, chickens, ducks, and geese are examples."
  },
  {
    "id": 1052,
    "subject": "Music",
    ...
    "correctAnswer": "C",
    "explanation": "A flute is a wind instrument that produces sound when a stream of air is directed against the edge of a hole."
  },
  {
    "id": 1053,
    "subject": "Home Science",
    "question": "A needlework tool used to protect the finger when pushing the needle is called a:",
    "options": {
      "A": "Tape measure",
      "B": "Thimble",
      "C": "Pin cushion",
    ...
    "correctAnswer": "B",
    "explanation": "A thimble is a small hard cup (metal or plastic) worn on the finger to protect it from being pricked when pushing a needle through fabric."
  },
  {
    "id": 1054,
    "subject": "Physical & Health Education",
    "question": "In a 100m sprint, the command given by the starter before 'Go' (gunshot) is:",
    "options": {
      "A": "Run",
    ...
    "correctAnswer": "B",
    "explanation": "The standard sequence for sprint starts is 'On your marks' (get into position), 'Set' (lift hips/brace), followed by the Gun/Signal."
  },
  {
    "id": 1055,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "A",
    "explanation": "WWW stands for World Wide Web, which is the system of interlinked documents and other resources accessed via the Internet."
  },
  {
    "id": 1056,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "$1 \\text{ kg} = 1000 \\text{ g}$. $2.5 \\text{ kg} \\times 1000 = 2500 \\text{ g}$."
  },
  {
    "id": 1057,
    "subject": "English",
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Ngeli ya M-MI huhusisha mimea na miti (Mti - Miti, Mchungwa - Michungwa)."
  },
  {
    "id": 1059,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "B",
    "explanation": "Mushrooms belong to the Kingdom Fungi. They lack chlorophyll and cannot photosynthesize, so they are not green plants."
  },
  {
    "id": 1060,
    "subject": "Social Studies",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "In Genesis, God saw that it was not good for man to be alone, so He created Eve to be a suitable helper and companion."
  },
  {
    "id": 1062,
    "subject": "Agriculture",
    ...
    "correctAnswer": "B",
    "explanation": "Weeds reduce crop yield by fighting (competing) for the essential resources that the crops need to grow."
  },
  {
    "id": 1063,
    "subject": "Music",
    ...
    "correctAnswer": "C",
    "explanation": "In standard common time ($4/4$), a Semibreve lasts for 4 beats, Minim for 2, Crotchet for 1, and Quaver for $1/2$."
  },
  {
    "id": 1064,
    "subject": "Home Science",
    ...
    "correctAnswer": "C",
    "explanation": "Frying is the cooking of food in hot fats or oils (e.g., shallow frying, deep frying)."
  },
  {
    "id": 1065,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "Tennis is played using a racquet to hit a ball over a net. Other examples include Badminton and Squash."
  },
  {
    "id": 1066,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "C",
    "explanation": "Hard copy is a physical reproduction of a document, usually on paper, as opposed to a soft copy which is digital."
  },
  {
    "id": 1067,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Present Continuous uses the auxiliary verb 'is/am/are' + verb ending in '-ing' to show an action happening right now."
  },
  {
    "id": 1069,
    "subject": "Kiswahili",
    ...
    "correctAnswer": "A",
    "explanation": "Visawe ni maneno yenye maana sawa. Barabara ni sawa na njia au njia kuu."
  },
  {
    "id": 1070,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "B",
    "explanation": "Amphibians (like frogs and toads) can live both in water and on land. They typically start life in water with gills and develop lungs as adults."
  },
  {
    "id": 1071,
    "subject": "Social Studies",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "According to Genesis, God finished his work on the sixth day and rested on the seventh day (Sabbath)."
  },
  {
    "id": 1073,
    "subject": "Agriculture",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "A conductor directs a musical performance by way of visible gestures with the hands, arms, face and head."
  },
  {
    "id": 1075,
    "subject": "Home Science",
    ...
    "correctAnswer": "C",
    "explanation": "Calcium is a mineral that is vital for building strong bones and teeth."
  },
  {
    "id": 1076,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "Cooling down allows the heart rate and breathing to return to normal slowly and helps remove waste products (lactic acid) from muscles to prevent soreness."
  },
  {
    "id": 1077,
    "subject": "ICT/Computer Studies",
    "question": "Which key is used to erase the character to the LEFT of the cursor?",
    "options": {
      "A": "Delete",
      "B": "Backspace",
      "C": "Spacebar",
    ...
    "correctAnswer": "B",
    "explanation": "Backspace erases text backwards (to the left). Delete erases text forwards (to the right)."
  },
  {
    "id": 1078,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "Subtract $9$ from both sides to isolate $y$: $y = 20 - 9$. $y = 11$."
  },
  {
    "id": 1079,
    "subject": "English",
    ...
    "correctAnswer": "D",
    "explanation": "Proper nouns name specific people, places, or things and are capitalized. London is a specific city. The others are common nouns."
  },
  {
    "id": 1080,
    "subject": "Kiswahili",
    ...
    "correctAnswer": "B",
    "explanation": "Mwalimu Mkuu (Headteacher) ndiye kiongozi msimamizi wa shule."
  },
  {
    "id": 1081,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "C",
    "explanation": "A pulley is a simple machine that uses a wheel with a groove and a rope to lift or lower heavy loads."
  },
  {
    "id": 1082,
    "subject": "Social Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Mangrove forests are distinct shrubs/trees that grow in coastal saline or brackish water."
  },
  {
    "id": 1083,
    "subject": "CRE",
    ...
    "correctAnswer": "B",
    "explanation": "Pentecost marks the descent of the Holy Spirit upon the Apostles and other followers of Jesus, giving them the power to speak in tongues."
  },
  {
    "id": 1084,
    "subject": "Agriculture",
    ...
    "correctAnswer": "C",
    "explanation": "Legumes are plants that produce seeds in pods, like beans, peas, and groundnuts. They are good for soil nitrogen."
  },
  {
    "id": 1085,
    "subject": "Music",
    ...
    "correctAnswer": "C",
    "explanation": "As the name suggests, the Triangle is a percussion instrument bent into the shape of a triangle."
  },
  {
    "id": 1086,
    "subject": "Home Science",
    ...
    "correctAnswer": "B",
    "explanation": "Shoe polish nourishes the leather and gives it a shine, while water can damage leather if soaked."
  },
  {
    "id": 1087,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "A",
    "explanation": "Skipping rope is an intense cardiovascular exercise that strengthens the heart and lungs."
  },
  {
    "id": 1088,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "A folder (directory) is a virtual container used to organize files and other folders on a computer storage device."
  },
  {
    "id": 1089,
    "subject": "Mathematics",
    "question": "If a rectangle has an area of $50$ cm² and a length of $10$ cm, what is its width?",
    "options": {
      "A": "5 cm",
      "B": "40 cm",
      "C": "500 cm",
    ...
    "correctAnswer": "A",
    "explanation": "Area = Length $\\times$ Width. $50 = 10 \\times \\text{Width}$. Width = $50 / 10 = 5 \\text{ cm}$."
  },
  {
    "id": 1090,
    "subject": "English",
    "question": "Which prefix can be added to the word 'happy' to make its opposite?",
    "options": {
      "A": "Dis-",
      "B": "Un-",
      "C": "Re-",
    ...
    "correctAnswer": "B",
    "explanation": "The prefix 'Un-' is added to 'happy' to create 'Unhappy', which means not happy."
  },
  {
    "id": 1091,
    "subject": "Kiswahili",
    ...
    "correctAnswer": "B",
    "explanation": "Katika Kiswahili, nyanya ni sawa na bibi (mama ya baba au mama ya mama)."
  },
  {
    "id": 1092,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "C",
    "explanation": "Condensation is the process where gas (like steam) cools down and turns back into liquid water."
  },
  {
    "id": 1093,
    "subject": "Social Studies",
    ...
    "correctAnswer": "C",
    "explanation": "JKIA is the largest and busiest airport in Kenya, serving Nairobi."
  },
  {
    "id": 1094,
    "subject": "CRE",
    ...
    "correctAnswer": "B",
    "explanation": "Cain killed his brother Abel out of jealousy because God accepted Abel's offering but not Cain's."
  },
  {
    "id": 1095,
    "subject": "Agriculture",
    ...
    "correctAnswer": "B",
    "explanation": "Mulching involves covering the soil with dry grass or plastic to reduce evaporation, thereby conserving moisture."
  },
  {
    "id": 1096,
    "subject": "Music",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Cotton is obtained from the cotton plant, making it a natural fibre. The others are man-made (synthetic)."
  },
  {
    "id": 1098,
    "subject": "Physical & Health Education",
    "question": "Which nutrient is most important for a marathon runner before a race?",
    "options": {
      "A": "Carbohydrates",
      "B": "Vitamins",
      "C": "Fats",
    ...
    "correctAnswer": "A",
    "explanation": "Carbohydrates provide the energy stamina needed for endurance activities like marathon running."
  },
  {
    "id": 1099,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "A modem or router is the hardware device that enables a computer to transmit data over telephone or cable lines, providing internet access."
  },
  {
    "id": 1100,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "The verb forms are: Write (Base), Wrote (Past Simple), Written (Past Participle)."
  },
  {
    "id": 1102,
    "subject": "Kiswahili",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Mercury is the first planet in the solar system and is closest to the Sun."
  },
  {
    "id": 1104,
    "subject": "Social Studies",
    ...
    "correctAnswer": "A",
    "explanation": "The County Assembly makes laws for the county (like Parliament does for the nation). The County Executive Committee implements them."
  },
  {
    "id": 1105,
    "subject": "CRE",
    ...
    "correctAnswer": "B",
    "explanation": "Daniel was thrown into the lions' den because he continued to pray to God despite the King's decree, and God sent an angel to shut the lions' mouths."
  },
  {
    "id": 1106,
    "subject": "Agriculture",
    ...
    "correctAnswer": "B",
    "explanation": "Locusts and grasshoppers have strong mandibles (jaws) for biting and chewing leaves. Aphids are piercing and sucking pests."
  },
  {
    "id": 1107,
    "subject": "Music",
    ...
    "correctAnswer": "B",
    "explanation": "The Kayamba is a traditional reed shaker used in Kenya, played by shaking it rhythmically."
  },
  {
    "id": 1108,
    "subject": "Home Science",
    ...
    "correctAnswer": "B",
    "explanation": "Brushing removes food particles and plaque that cause tooth decay and cavities."
  },
  {
    "id": 1109,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "A penalty is a direct free kick taken from the penalty spot, awarded for serious fouls committed by a defender inside their own penalty area."
  },
  {
    "id": 1110,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Google Chrome, Firefox, Edge, and Safari are examples of web browsers."
  },
  {
    "id": 1111,
    "subject": "Mathematics",
    ...
    "correctAnswer": "C",
    "explanation": "An acute angle measures between $0$ and $90$ degrees. A right angle is exactly $90$. An obtuse is between $90$ and $180$."
  },
  {
    "id": 1112,
    "subject": "English",
    ...
    "correctAnswer": "B",
    "explanation": "Child is an irregular noun. The plural is Children (never 'childrens')."
  },
  {
    "id": 1113,
    "subject": "Kiswahili",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Root hairs increase the surface area of the root system to maximize the absorption of water and minerals from the soil."
  },
  {
    "id": 1115,
    "subject": "Social Studies",
    ...
    "correctAnswer": "C",
    "explanation": "The Vasco da Gama Pillar is a historical monument in Malindi, built by the Portuguese explorer Vasco da Gama in 1498."
  },
  {
    "id": 1116,
    "subject": "CRE",
    ...
    "correctAnswer": "B",
    "explanation": "According to Exodus, Moses went up to Mount Sinai to receive the stone tablets containing the Ten Commandments from God."
  },
  {
    "id": 1117,
    "subject": "Agriculture",
    ...
    "correctAnswer": "B",
    "explanation": "A mattock (or pickaxe) has a heavy metal head used for breaking up hard, rocky soil or digging trenches."
  },
  {
    "id": 1118,
    "subject": "Music",
    "question": "What is the sol-fa name for the 5th note of the scale (d - r - m - f - ?)?",
    "options": {
      "A": "La",
      "B": "So",
      "C": "Ti",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Puberty is the process of physical changes through which a child's body matures into an adult body capable of sexual reproduction."
  },
  {
    "id": 1120,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "Swimming takes place in water. The others are land-based sports."
  },
  {
    "id": 1121,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "The CPU is often called the brain because it handles all the instructions and calculations needed for the computer to work."
  },
  {
    "id": 1122,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "$7 \\times 1 = 7$; $7 \\times 2 = 14$; $7 \\times 3 = 21$. 21 is in the 7 times table."
  },
  {
    "id": 1123,
    "subject": "English",
    ...
    "correctAnswer": "B",
    "explanation": "Adjectives describe nouns. 'Beautiful' describes a noun (e.g., beautiful flower). Run (verb), Boy (noun), Quickly (adverb)."
  },
  {
    "id": 1124,
    "subject": "Kiswahili",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Iron, nickel, and cobalt are magnetic materials. Magnets attract them."
  },
  {
    "id": 1126,
    "subject": "Social Studies",
    ...
    "correctAnswer": "C",
    "explanation": "Nanyuki is a famous town located on the equator. There are signs in the town marking the crossing."
  },
  {
    "id": 1127,
    "subject": "CRE",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "A granary is a traditional or modern store used for keeping grain dry and safe from pests."
  },
  {
    "id": 1129,
    "subject": "Music",
    ...
    "correctAnswer": "C",
    "explanation": "Sacred songs, hymns, or gospel songs are sung for religious purposes to praise or worship God."
  },
  {
    "id": 1130,
    "subject": "Home Science",
    ...
    "correctAnswer": "B",
    "explanation": "Using serving spoons ensures hygiene and prevents contamination of the food."
  },
  {
    "id": 1131,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "Stretching exercises elongate the muscles and improve the range of motion in joints (flexibility)."
  },
  {
    "id": 1132,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "The Caps Lock key toggles capital letters on and off. When on, all typed letters appear in uppercase."
  },
  {
    "id": 1133,
    "subject": "Mathematics",
    "question": "The perimeter of a square is $20$ cm. What is the length of one side?",
    "options": {
      "A": "5 cm",
      "B": "4 cm",
      "C": "10 cm",
    ...
    "correctAnswer": "A",
    "explanation": "Perimeter of square = $4 \\times \\text{Side}$. $20 = 4 \\times \\text{Side}$. Side = $20 / 4 = 5 \\text{ cm}$."
  },
  {
    "id": 1134,
    "subject": "English",
    ...
    "correctAnswer": "B",
    "explanation": "The subject 'I' takes the verb 'have'. 'He/She/It' takes 'has'."
  },
  {
    "id": 1135,
    "subject": "Kiswahili",
    ...
    "correctAnswer": "A",
    "explanation": "Ugonjwa ni nomino ya ngeli ya U-U (Ugonjwa - Magonjwa). Mara nyingi huwekwa U-YA (kama U-MA)."
  },
  {
    "id": 1136,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "B",
    "explanation": "Temperature is commonly measured in degrees Celsius ($^{\\circ}C$) or Fahrenheit ($^{\\circ}F$). Kg is for mass, Metre for length."
  },
  {
    "id": 1137,
    "subject": "Social Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Coffee (Arabica) thrives in high altitude areas with cool temperatures and reliable rainfall (Central Kenya, Kisii)."
  },
  {
    "id": 1138,
    "subject": "CRE",
    "question": "The three wise men brought Jesus gifts of Gold, Frankincense, and ___.",
    "options": {
      "A": "Silver",
      "B": "Myrrh",
      "C": "Bronze",
    ...
    "correctAnswer": "B",
    "explanation": "The Magi (Wise Men) presented gifts of Gold (kingship), Frankincense (deity/priest), and Myrrh (death/suffering)."
  },
  {
    "id": 1139,
    "subject": "Agriculture",
    ...
    "correctAnswer": "A",
    "explanation": "A hutch is a type of cage or house specifically used for keeping rabbits."
  },
  {
    "id": 1140,
    "subject": "Music",
    ...
    "correctAnswer": "B",
    "explanation": "Percussion instruments make sound when hit, shaken, or scraped. A drum is hit."
  },
  {
    "id": 1141,
    "subject": "Home Science",
    ...
    "correctAnswer": "B",
    "explanation": "Handwashing at critical times (after toilet, before food) is the best way to prevent the spread of germs."
  },
  {
    "id": 1142,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "C",
    "explanation": "Races run on the track (sprints, middle distance) are track events. Jumps and throws are field events."
  },
  {
    "id": 1143,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": ".docx is the standard file extension for Microsoft Word documents. .mp3 is audio, .jpg is image, .xls is Excel."
  },
  {
    "id": 1144,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "$\frac{4}{100}$ means four hundredths. As a decimal, the 4 goes in the second decimal place: $0.04$."
  },
  {
    "id": 1145,
    "subject": "English",
    ...
    "correctAnswer": "A",
    "explanation": "Conjunctions connect words or clauses. 'Because' connects a result with a reason."
  },
  {
    "id": 1146,
    "subject": "Kiswahili",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "The Sun provides the solar energy essential for life on Earth."
  },
  {
    "id": 1148,
    "subject": "Social Studies",
    ...
    "correctAnswer": "B",
    "explanation": "The Chief Justice is the head of the Judiciary and the President of the Supreme Court."
  },
  {
    "id": 1149,
    "subject": "CRE",
    ...
    "correctAnswer": "B",
    "explanation": "Matthew is the first of the four Gospels and the first book of the New Testament."
  },
  {
    "id": 1150,
    "subject": "Agriculture",
    ...
    "correctAnswer": "C",
    "explanation": "Cereals are grasses grown for their edible grain (maize, wheat, rice, sorghum)."
  },
  {
    "id": 1151,
    "subject": "Music",
    ...
    "correctAnswer": "C",
    "explanation": "Pitch refers to the frequency of a sound wave—whether it sounds high (like a whistle) or low (like a drum)."
  },
  {
    "id": 1152,
    "subject": "Home Science",
    ...
    "correctAnswer": "C",
    "explanation": "A balanced diet contains all the food groups (carbs, proteins, vitamins, fats, water) in the right amounts."
  },
  {
    "id": 1153,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "Jogging slowly raises the heart rate gradually and warms up the muscles."
  },
  {
    "id": 1154,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Hardware refers to the tangible components (screen, keyboard, mouse, chips)."
  },
  {
    "id": 1155,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Tunda la mti wa mbuyu huitwa 'buhuu' au 'mabungo' (mbegu zake zikitengenezwa huitwa ubuyu)."
  },
  {
    "id": 1158,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "C",
    "explanation": "Sound travels fastest through solids because the particles are packed closely together, allowing vibrations to pass quickly."
  },
  {
    "id": 1159,
    "subject": "Social Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Lake Nakuru is a soda lake famous for the millions of flamingos that flock there (though numbers vary due to water levels)."
  },
  {
    "id": 1160,
    "subject": "CRE",
    "question": "The commandment 'Do not commit adultery' respects the institution of:",
    "options": {
      "A": "School",
      "B": "Marriage",
      "C": "Work",
    ...
    "correctAnswer": "B",
    "explanation": "Adultery is a sin against marriage, so the commandment protects the sanctity of marriage."
  },
  {
    "id": 1161,
    "subject": "Agriculture",
    ...
    "correctAnswer": "B",
    "explanation": "A knapsack sprayer is carried on the back and used to apply herbicides or pesticides to crops evenly."
  },
  {
    "id": 1162,
    "subject": "Music",
    ...
    "correctAnswer": "B",
    "explanation": "'Kenya Nchi Yetu' is a well-known patriotic song expressing love for the country."
  },
  {
    "id": 1163,
    "subject": "Home Science",
    "question": "The method of preserving meat by exposing it to smoke is called:",
    "options": {
      "A": "Salting",
      "B": "Smoking",
      "C": "Freezing",
    ...
    "correctAnswer": "B",
    "explanation": "Smoking dries the meat and adds chemicals from the smoke that kill bacteria and add flavor."
  },
  {
    "id": 1164,
    "subject": "Physical & Health Education",
    "question": "A pass in basketball where the ball hits the floor before reaching the teammate is called a:",
    "options": {
      "A": "Chest pass",
      "B": "Bounce pass",
      "C": "Overhead pass",
    ...
    "correctAnswer": "B",
    "explanation": "In a bounce pass, the ball bounces once on the floor between the passer and the receiver."
  },
  {
    "id": 1165,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "C",
    "explanation": "The Enter key creates a new paragraph or moves the cursor to the beginning of the next line."
  },
  {
    "id": 1166,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Crocodiles are reptiles (cold-blooded, scales, lay eggs). Toads are amphibians, whales are mammals, eagles are birds."
  },
  {
    "id": 1170,
    "subject": "Social Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Before modern medicine, traditional healers used various plants, herbs, roots, and bark to treat ailments."
  },
  {
    "id": 1171,
    "subject": "CRE",
    ...
    "correctAnswer": "C",
    "explanation": "Jesus defined 'neighbour' as anyone who is in need of mercy, regardless of their background."
  },
  {
    "id": 1172,
    "subject": "Agriculture",
    ...
    "correctAnswer": "B",
    "explanation": "Carrots are enlarged taproots eaten as vegetables. Spinach/Cabbage are leafy; Tomato is a fruit."
  },
  {
    "id": 1173,
    "subject": "Music",
    ...
    "correctAnswer": "B",
    "explanation": "To soothe a baby to sleep, the music must be soft, slow, and gentle."
  },
  {
    "id": 1174,
    "subject": "Home Science",
    ...
    "correctAnswer": "A",
    "explanation": "Vitamin A is essential for good vision, especially in low light. Deficiency causes night blindness."
  },
  {
    "id": 1175,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "Runners pass a hollow tube called a baton to the next runner in a relay team."
  },
  {
    "id": 1176,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "The Recycle Bin (where deleted files go) is usually represented by a trash can icon."
  },
  {
    "id": 1177,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Kiswahili is the National Language (symbol of unity), while English and Kiswahili are both Official Languages."
  },
  {
    "id": 1182,
    "subject": "CRE",
    ...
    "correctAnswer": "A",
    "explanation": "In the miracle of the feeding of the 5000, Jesus multiplied five loaves of bread and two fish."
  },
  {
    "id": 1183,
    "subject": "Agriculture",
    "question": "Which animal is known as a 'beast of burden' (used for transport)?",
    "options": {
      "A": "Donkey",
      "B": "Cat",
      "C": "Sheep",
    ...
    "correctAnswer": "A",
    "explanation": "Donkeys (and camels) are used to carry heavy loads and transport goods."
  },
  {
    "id": 1184,
    "subject": "Music",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Composting turns organic kitchen waste (peels, leftovers) into manure for the garden."
  },
  {
    "id": 1186,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "The referee blows a whistle to start and stop play in football."
  },
  {
    "id": 1187,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "C",
    "explanation": "In touch typing, the thumb (usually the right thumb) is used to press the spacebar."
  },
  {
    "id": 1188,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "The rule is 'i' before 'e' except after 'c'. So, R-E-C-E-I-V-E."
  },
  {
    "id": 1190,
    "subject": "Kiswahili",
    ...
    "correctAnswer": "A",
    "explanation": "Nanasi ni tunda tamu (kama yai la kuku) lakini mmea wake una miiba."
  },
  {
    "id": 1191,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "B",
    "explanation": "Arteries carry oxygenated blood away from the heart to the body. Veins carry blood back to the heart."
  },
  {
    "id": 1192,
    "subject": "Social Studies",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "A heifer is a young female cow. Once she gives birth, she is called a cow."
  },
  {
    "id": 1195,
    "subject": "Music",
    ...
    "correctAnswer": "B",
    "explanation": "Horns made from animal horns (like the Kudu) are traditional wind instruments in many African communities."
  },
  {
    "id": 1196,
    "subject": "Home Science",
    ...
    "correctAnswer": "B",
    "explanation": "Charcoal is produced by burning wood in a low-oxygen environment (carbonization)."
  },
  {
    "id": 1197,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "C",
    "explanation": "If neither team manages to pull the other across the line within the time or rules, it is a draw."
  },
  {
    "id": 1198,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "A",
    "explanation": "The System Tray (usually bottom right corner on Windows) displays the clock and date."
  },
  {
    "id": 1199,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "If the bird is flying above the tree without touching it, 'over' is the correct preposition."
  },
  {
    "id": 1201,
    "subject": "Mathematics",
    ...
    "correctAnswer": "C",
    "explanation": "In Roman Numerals, X = 10 and V = 5. Therefore, XV = 10 + 5 = 15."
  },
  {
    "id": 1202,
    "subject": "English",
    ...
    "correctAnswer": "A",
    "explanation": "The correct proverb is 'A stitch in time saves nine', meaning it is better to fix a problem immediately than to wait until it gets worse."
  },
  {
    "id": 1203,
    "subject": "Kiswahili",
    ...
    "correctAnswer": "B",
    "explanation": "Udogo wa neno 'dada' huanza na kiambishi 'Ki-'. Hivyo, dada mdogo ni 'Kidada'."
  },
  {
    "id": 1204,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "C",
    "explanation": "Canines are pointed teeth designed for gripping and tearing food, especially meat. Incisors bite, molars grind."
  },
  {
    "id": 1205,
    "subject": "Social Studies",
    ...
    "correctAnswer": "C",
    "explanation": "The Senator is elected to represent the interests of the County and its government in the Senate (National Parliament)."
  },
  {
    "id": 1206,
    "subject": "CRE",
    "question": "The story of the walls of Jericho falling down is associated with which leader?",
    "options": {
      "A": "Moses",
      "B": "Joshua",
      "C": "Aaron",
    ...
    "correctAnswer": "B",
    "explanation": "Joshua led the Israelites around the city of Jericho, and the walls fell down after they shouted and blew trumpets."
  },
  {
    "id": 1207,
    "subject": "Agriculture",
    "question": "Which of these is a biting and chewing pest that attacks maize stalks?",
    "options": {
      "A": "Stalk borer",
      "B": "Aphid",
      "C": "Tick",
    ...
    "correctAnswer": "A",
    "explanation": "The maize stalk borer is a larva that bores holes into the stem of maize plants, causing significant damage."
  },
  {
    "id": 1208,
    "subject": "Music",
    ...
    "correctAnswer": "C",
    "explanation": "For 'So' (Sol), the hand is held open with the palm facing the singer's chest (or flat vertical hand)."
  },
  {
    "id": 1209,
    "subject": "Home Science",
    "question": "Which nutritional deficiency disease causes weak and bowed legs in children?",
    "options": {
      "A": "Scurvy",
      "B": "Rickets",
      "C": "Malaria",
    ...
    "correctAnswer": "B",
    "explanation": "Rickets is caused by a lack of Vitamin D and Calcium, leading to soft bones and bowed legs."
  },
  {
    "id": 1210,
    "subject": "Physical & Health Education",
    "question": "The start of a 400m race is usually done using which start technique?",
    "options": {
      "A": "Standing start",
      "B": "Crouch start",
      "C": "Jump start",
    ...
    "correctAnswer": "B",
    "explanation": "For sprints (up to 400m), a crouch start (using starting blocks) is used to generate maximum power."
  },
  {
    "id": 1211,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "C",
    "explanation": "The 'Tab' key moves the cursor forward a set distance, commonly used for indenting paragraphs."
  },
  {
    "id": 1212,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Reflexive pronouns end in -self or -selves. Since the subject is 'He', the reflexive pronoun is 'himself'."
  },
  {
    "id": 1214,
    "subject": "Kiswahili",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Water is a liquid. Oxygen is a gas, and wood/stone are solids."
  },
  {
    "id": 1216,
    "subject": "Social Studies",
    "question": "The main economic activity of the Mijikenda people in the past was:",
    "options": {
    ...
    "correctAnswer": "A",
    "explanation": "Living along the coast, the Mijikenda practiced mixed farming and fishing."
  },
  {
    "id": 1217,
    "subject": "CRE",
    ...
    "correctAnswer": "B",
    "explanation": "Elisha told Naaman to wash in the River Jordan seven times to be healed of leprosy."
  },
  {
    "id": 1218,
    "subject": "Agriculture",
    ...
    "correctAnswer": "B",
    "explanation": "A rake is used to break up soil clumps, smooth the surface, and gather leaves."
  },
  {
    "id": 1219,
    "subject": "Music",
    ...
    "correctAnswer": "C",
    "explanation": "A Quaver (eighth note) lasts for half the duration of a Crotchet (quarter note)."
  },
  {
    "id": 1220,
    "subject": "Home Science",
    ...
    "correctAnswer": "B",
    "explanation": "Burns (from dry heat) and scalds (from hot liquids/steam) are frequent kitchen injuries."
  },
  {
    "id": 1221,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "C",
    "explanation": "Basketball is played by shooting a ball through a raised hoop (basket)."
  },
  {
    "id": 1222,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Flash drives (thumb drives) use the Universal Serial Bus (USB) port."
  },
  {
    "id": 1223,
    "subject": "Mathematics",
    ...
    "correctAnswer": "A",
    "explanation": "Align the decimal points and add: $4+2=6$ and $0.5+0.3=0.8$. Total is $6.8$."
  },
  {
    "id": 1224,
    "subject": "English",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "A cat is a mammal and has an internal skeleton with a backbone. The others are invertebrates."
  },
  {
    "id": 1227,
    "subject": "Social Studies",
    "question": "A low-lying area of land between hills or mountains is called a:",
    "options": {
      "A": "Plateau",
      "B": "Valley",
      "C": "Lake",
    ...
    "correctAnswer": "B",
    "explanation": "A valley is a depression or low area between hills, often with a river running through it."
  },
  {
    "id": 1228,
    "subject": "CRE",
    "question": "Which disciple doubted that Jesus had risen until he saw the wounds?",
    "options": {
      "A": "Peter",
      "B": "Thomas",
      "C": "John",
    ...
    "correctAnswer": "B",
    "explanation": "Thomas (often called Doubting Thomas) said he would not believe unless he saw the nail marks in Jesus' hands."
  },
  {
    "id": 1229,
    "subject": "Agriculture",
    ...
    "correctAnswer": "C",
    "explanation": "Clay soil has very fine particles and becomes sticky and heavy when wet."
  },
  {
    "id": 1230,
    "subject": "Music",
    ...
    "correctAnswer": "B",
    "explanation": "Tempo describes the speed at which a piece of music is played (e.g., fast, slow)."
  },
  {
    "id": 1231,
    "subject": "Home Science",
    ...
    "correctAnswer": "C",
    "explanation": "Hemming is used to finish the edge of a garment permanently. Tacking/Basting are temporary."
  },
  {
    "id": 1232,
    "subject": "Physical & Health Education",
    "question": "In handball, how many steps can a player take with the ball without dribbling?",
    "options": {
      "A": "10 steps",
      "B": "3 steps",
      "C": "5 steps",
    ...
    "correctAnswer": "B",
    "explanation": "In handball, the '3-step rule' allows a player to take a maximum of 3 steps with the ball."
  },
  {
    "id": 1233,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Android is a popular operating system used on smartphones and tablets."
  },
  {
    "id": 1234,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "From 9:00 to 10:00 is 60 minutes. From 10:00 to 10:30 is 30 minutes. $60 + 30 = 90$ minutes."
  },
  {
    "id": 1235,
    "subject": "English",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Carbon dioxide is heavier than air and does not support burning, so it smothers the fire."
  },
  {
    "id": 1238,
    "subject": "Social Studies",
    ...
    "correctAnswer": "A",
    "explanation": "Citizenship can be acquired by Birth or by Registration (for foreigners who qualify)."
  },
  {
    "id": 1239,
    "subject": "CRE",
    ...
    "correctAnswer": "C",
    "explanation": "According to Genesis, Adam was the first human created by God."
  },
  {
    "id": 1240,
    "subject": "Agriculture",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Long, dirty nails harbor germs that can be transferred to food or the mouth."
  },
  {
    "id": 1243,
    "subject": "Physical & Health Education",
    "question": "Which part of the foot is used to kick the ball for maximum power in football?",
    "options": {
      "A": "The heel",
      "B": "The toe",
      "C": "The instep (laces)",
    ...
    "correctAnswer": "C",
    "explanation": "The instep (the top part of the foot where the laces are) provides the hardest surface for power shots."
  },
  {
    "id": 1244,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Windows 10 is system software that manages computer hardware and software resources. Word is an application."
  },
  {
    "id": 1245,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "Perimeter = $2 \\times (L + W) = 2 \\times (8 + 3) = 2 \\times 11 = 22$ cm."
  },
  {
    "id": 1246,
    "subject": "English",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Methali kamili ni 'Pole pole ndio mwendo' (Slowly is the way/speed)."
  },
  {
    "id": 1248,
    "subject": "Science & Technology",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "The Independent Electoral and Boundaries Commission (IEBC) is responsible for conducting elections."
  },
  {
    "id": 1250,
    "subject": "CRE",
    "question": "The father of faith who was willing to sacrifice his son Isaac is:",
    "options": {
      "A": "Jacob",
      "B": "Abraham",
      "C": "Moses",
    ...
    "correctAnswer": "B",
    "explanation": "Abraham demonstrated great faith when God tested him by asking him to sacrifice his son Isaac."
  },
  {
    "id": 1251,
    "subject": "Agriculture",
    "question": "The removal of excess seedlings to reduce overcrowding is called:",
    "options": {
      "A": "Weeding",
      "B": "Pruning",
      "C": "Thinning",
    ...
    "correctAnswer": "C",
    "explanation": "Thinning ensures the remaining plants have enough space and nutrients to grow well."
  },
  {
    "id": 1252,
    "subject": "Music",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Cotton or specific synthetic blends are good for sports because they manage sweat and allow flexibility."
  },
  {
    "id": 1254,
    "subject": "Physical & Health Education",
    ...
    "correctAnswer": "B",
    "explanation": "An athletics track is oval, with two straights and two bends."
  },
  {
    "id": 1255,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "C",
    "explanation": "The mouse moves the cursor to point and click (select) items."
  },
  {
    "id": 1256,
    "subject": "Mathematics",
    ...
    "correctAnswer": "B",
    "explanation": "$2/4$ simplifies to $1/2$ (dividing numerator and denominator by 2)."
  },
  {
    "id": 1257,
    "subject": "English",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Wakati uliopo 'NA' hugeuka 'I' mwishoni na kiambishi cha kukanusha 'HA'. Hivyo: Hali."
  },
  {
    "id": 1259,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "B",
    "explanation": "Solids maintain their shape and volume unless force is applied."
  },
  {
    "id": 1260,
    "subject": "Social Studies",
  ...
  },
  {
    "id": 1261,
    "subject": "CRE",
    "question": "The Bible is divided into two main parts: The Old Testament and the ___.",
    "options": {
      "A": "New Testament",
      "B": "Story Book",
      "C": "Quran",
    ...
    "correctAnswer": "A",
    "explanation": "The Christian Bible consists of the Old Testament and the New Testament."
  },
  {
    "id": 1262,
    "subject": "Agriculture",
    "question": "Manure made from decomposed plant and animal waste in a pit is called:",
    "options": {
    ...
    "correctAnswer": "B",
    "explanation": "Compost is organic matter that has been decomposed in a heap or pit."
  },
  {
    "id": 1263,
    "subject": "Music",
    ...
    "correctAnswer": "A",
    "explanation": "The Litungu is a seven-stringed lyre played by the Luhya people."
  },
  {
    "id": 1264,
    "subject": "Home Science",
    ...
    "correctAnswer": "B",
    "explanation": "Feet sweat, creating a damp environment for bacteria and fungi. Changing socks keeps feet dry and healthy."
  },
  {
    "id": 1265,
    "subject": "Physical & Health Education",
    "question": "The skill of bouncing the ball with one hand in basketball is called:",
    "options": {
      "A": "Passing",
      "B": "Dribbling",
      "C": "Shooting",
    ...
    "correctAnswer": "B",
    "explanation": "Dribbling allows a player to move around the court while retaining possession of the ball."
  },
  {
    "id": 1266,
    "subject": "ICT/Computer Studies",
    ...
    "correctAnswer": "B",
    "explanation": "Backspace removes the character immediately before the cursor (to the left)."
  },
  {
    "id": 1267,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Kijiko (KI-) huchukua wingi Vijiko (VI-). Viambishi pia hubadilika: Ki-li $\to$ Vi-li."
  },
  {
    "id": 1270,
    "subject": "Science & Technology",
    ...
    "correctAnswer": "B",
    "explanation": "Dark colours like black absorb more heat radiation, while white reflects it."
  },
  {
    "id": 1271,
    "subject": "Social Studies",
    ...
    "correctAnswer": "A",
    "explanation": "In a traditional family structure, the father or parents are the heads of the unit."
  },
  {
    "id": 1272,
    "subject": "CRE",
    ...
    "correctAnswer": "C",
    "explanation": "Solomon asked God for wisdom to rule his people, and he is famous for his wise judgments."
  },
  {
    "id": 1273,
    "subject": "Agriculture",
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Volleyball is played by two teams of players working together."
  },
  {
    "id": 1277,
    "subject": "ICT/Computer Studies",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Jomo Kenyatta became the first President after independence in 1963/1964."
  },
  {
    "id": 1283,
    "subject": "CRE",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Cotton produces fibres that are spun into yarn for making textiles."
  },
  {
    "id": 1285,
    "subject": "Music",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Carbohydrates (starches and sugars) are the main energy source."
  },
  {
    "id": 1288,
    "subject": "ICT/Computer Studies",
    "question": "Which key creates a capital letter when held down with another key?",
    "options": {
      "A": "Shift",
      "B": "Enter",
      "C": "Ctrl",
    ...
    "correctAnswer": "A",
    "explanation": "Holding Shift while pressing a letter types the uppercase version."
  },
  {
    "id": 1289,
    "subject": "Mathematics",
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Tea is grown mainly for sale (export) rather than direct family consumption."
  },
  {
    "id": 1294,
    "subject": "CRE",
