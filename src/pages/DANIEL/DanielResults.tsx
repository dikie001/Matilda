...
// Must match the ID used in Daniel's Quiz App
...
const DanielResults = () => {
  ...
  useEffect(() => {
    setIsClient(true);
    // 1. Fetch Data from LocalStorage using DANIEL's keys
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pt-24 pb-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h1 className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-orange-500 to-orange-500">
              Daniel's Results
            </h1>
          ...
          {isClient && graphData.length > 0 && (
            <PDFDownloadLink
              ...
              fileName="Daniel's Report.pdf"
            >
              {({ loading: pdfLoading }) => (
                <Button
                  className="bg-orange-600 cursor-pointer hover:bg-orange-700 text-white shadow-lg shadow-orange-200 dark:shadow-none transition-all border-none"
                  disabled={pdfLoading}
                >
                  {pdfLoading ? (
