...
// Unique ID for Daniel to separate his data
...
const DanielQuickQuiz: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-100 to-teal-200 dark:bg-gray-900 dark:from-transparent dark:via-transparent dark:to-transparent flex items-center justify-center transition-colors duration-300">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
          ...
          <p className="text-orange-600 dark:text-orange-400 text-lg font-semibold">
            Loading Quiz Data...
          </p>
        </div>
      </div>
          ...
          <div className="max-w-2xl mx-auto w-full space-y-6">
            ...
            {state.currentTest < getTotalTests() && (
              <button
                ...
                className="group relative w-full cursor-pointer overflow-hidden rounded-3xl bg-gradient-to-r from-orange-600 to-orange-700 p-1 shadow-xl transition-all duration-300 hover:scale-[1.01] hover:shadow-emerald-500/25"
              >
                <div className="relative flex items-center justify-between rounded-[14px] bg-white/10 px-6 py-5 sm:px-8 sm:py-6 transition-colors group-hover:bg-white/20">
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm transition-transform duration-300 group-hover:translate-x-1 group-hover:bg-white text-white group-hover:text-orange-700">
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-green-100 dark:bg-gray-900 dark:from-transparent dark:via-transparent dark:to-transparent flex items-center justify-center transition-colors duration-300">
          ...
          <div className="text-center pt-16">
            ...
            <button
              ...
              className="flex items-center text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 transition-colors font-semibold"
            >
        ...
        <div className="max-w-4xl mx-auto pt-16 md:pt-12 ">
          ...
          <div className="bg-gray-50/80 dark:bg-gray-800/70 backdrop-blur-md rounded-3xl px-6 py-6 border border-emerald-200 dark:border-emerald-900/30 shadow-lg shadow-emerald-200/20 dark:shadow-none transition-all duration-300">
            ...
            {state.showFeedback && (
              <button
                onClick={handleNext}
                className="w-full mt-4 bg-gradient-to-r from-orange-600 to-orange-600 dark:from-orange-700 dark:to-orange-800 text-white font-bold py-4 rounded-2xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg shadow-emerald-200/40 dark:shadow-none flex items-center justify-center gap-2"
              >
  ...
  if (state.gameState === "results") {
    ...
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-emerald-50 to-orange-100 dark:bg-gray-900 dark:from-transparent dark:via-transparent dark:to-transparent font-sans text-gray-900 dark:text-gray-100 transition-colors duration-300">
...
export default DanielQuickQuiz;
